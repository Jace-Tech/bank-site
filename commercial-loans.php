...
<head>
  ...
  <link rel="canonical" href="commercial-loans.php" />
  ...
  <link rel="alternate" hreflang="en" href="commercial-loans.php" />

  <title>Commercial Loans | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-commercial-loans path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <?php include("./header.php"); ?>
      <header>
        <?php include("./nav.php"); ?>
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/commercial-loans-internal.png?VersionId=x7xSCACVsy4m9UObs8imUqW1Z1Ot6d2z); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">


              <h1> Commercial Loans</h1>
              <p>Beko Federal Credit Union has multiple loan products and programs to make sure your financing fits the unique needs of your business. From construction financing to working capital, Beko Federal Credit Union will be your financial partner for the long-term.<sup>1</sup></p>

            </div>

            <div class="banner-button">
              <p>We're ready to be your business partner.</p>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/commercial-loans" typeof="schema:WebPage">


                    <span property="schema:name" content="Commercial Loans" class="hidden"></span>
                    ...
                    <div>
                      ...
                      <div class="q2-section grid-section cards gutter-both">
                            ...
                            <div class="cell small-12 medium-6 large-4 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/cards_construction-loans.png?VersionId=QhSWZDZwMpItuPqFfNwi3grU1o.sBwa4" width="270" height="229" alt="Two people shaking hands" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <h3>Commercial Real Estate & Construction Loans</h3>

                              <p>Whether you are refinancing, expanding, relocating or initially buying business property, we have financing options available.</p>



                              <a href="contact-us.php" class="button" aria-label="COMMERCIAL REAL ESTATE &amp; CONSTRUCTION LOANS application">START HERE</a>
                            ...
                            <div class="cell small-12 medium-6 large-4 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/cards_line-of-credit.png?VersionId=sjahs9bPFxJF7_ZlVPx6t5lRCXcACQoQ" width="270" height="229" alt="Hand holding card and cell phone" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <h3>Working Capital Lines of Credit/Revolving Line of Credit</h3>

                              <p>Give your business access to extra cash for when unexpected opportunities come up.</p>



                              <a href="contact-us.php" class="button" aria-label="WORKING CAPITAL LINES OF CREDIT/REVOLVING LINE OF CREDIT application">START HERE</a>
                            ...
                            <div class="cell small-12 medium-6 large-4 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/cards_equipment-financing.png?VersionId=rTwuOs0YkNJ9XOwI1Oyxvrd3w7IjpkAt" width="270" height="229" alt="Hand drawing out architecture design" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <p>From large equipment to small, we have the loan that's right for your business.&nbsp;</p>



                              <a href="contact-us.php" class="button" aria-label="EQUIPMENT FINANCING application">START HERE</a>
                      ...
                      <div class="q2-section call-to-action-section primary gutter-none">
                        <div class="q2-wrap">
                          <p>Have a farm financing need? Learn about our Ag Loans.</p>

                          <a href="personal/borrow/consumer-loans-overview/agriculture-loans.php" class="button" aria-label="Learn More through our Agricultural loans page">Learn More</a>
                        ...
                        <div class="q2-wrap grid-container">
                          ...
                          <div id="loans">
                            ...
                            <div class="section-summary">&nbsp;
                              <p>At First United, we aim to make the commercial loan process as hassle free as possible. If you want to get started collecting the documents for your loan, browse or <strong>print</strong> the checklists below. If you're unsure whether an item applies to your situation, give us a call at <strong>(800)924-4427</strong> and ask for a commercial lender in your area.</p>
                            </div>
                          </div>
                      ...
                      <div class="q2-section general-section gutter-none grey">
                        <div class="q2-wrap grid-container">

                          <div id="loans">
                            <h3 class="comm-title" style="padding-bottom: 1rem">Commercial Loan Checklist</h3>
                          ...
                          <div class="grid-x grid-margin-y">
                            ...
                            <div class="cell small-12 ">
                              <ul class="accordion" data-responsive-accordion-tabs="accordion" data-multi-expand="false" data-allow-all-closed="true">
                                ...
                                <li class=" accordion-item is-active" data-accordion-item="data-accordion-item" data-q2-deep-link-id="business-information-documents-1008">
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="accordion-tab-content">
                                      ...
                                      <ul>
                                        <li>Current Balance Sheet and current year Profit and Loss Statement for the business</li>
                                        <li>Accounts Receivable</li>
                                        <li>Accounts Payable</li>
                                        <li>Last three (3) years' Tax Returns</li>
                                        <li>Last three three (3) years' Income Statement and Balance Sheet</li>
                                        <li>Business Debt Schedule</li>
                                        <li>Month by Month Projections for remainder of the year and next calendar year</li>
                                        <li>Description of Business/Business Plan</li>
                                      </ul>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="-individual-guarantor-information-1009">
                                  <a href="#" class="accordion-title">
                                    <h2>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="accordion-tab-content">
                                      ...
                                      <p><strong><em>For those with 20% or more ownership interest in the business</em></strong>:&nbsp;</p>

                                      <ul>
                                        <li>Individual Financial Statement, less than 60 days old</li>
                                        <li>Federal Tax Return (3 years); all schedules, statements, K-1s and W-2s (needed for outside income)</li>
                                        <li>Last three (3) years' Income Statement and Balance Sheet</li>
                                        <li>Summary of current financing (Global Debt Schedule)</li>
                                        <li>Bio/Resume of the Principal(s)</li>
                                        <li>Copy of valid Drivers License</li>
                                        <li>Contingent Liabilities Statement</li>
                                      </ul>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="business/corporate-guarantor-information-1011">
                                  <a href="#" class="accordion-title">
                                    <h2>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="accordion-tab-content">
                                      ...
                                      <ul>
                                        <li>Current Financial Statement, less than 60 days old</li>
                                        <li>Federal Tax Return (3 years); all schedules</li>
                                        <li>Last three (3) years' Income Statement and Balance Sheet</li>
                                        <li>Summary of current financing (Business Debt Schedule)</li>
                                      </ul>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="legal-entity-documentation-1012">
                                  <a href="#" class="accordion-title">
                                    <h2>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="accordion-tab-content">
                                      ...
                                      <ul>
                                        ...
                                        <li>"Doing Business As" documentation</li>
                                        <li>Franchise Agreement</li>
                                        <li>LLC: Certificate of LLC and Operating Agreement</li>
                                      </ul>
                      ...
                      <div class="q2-section general-section gutter-none grey">
                        <div class="q2-wrap grid-container">
                          ...
                          <div id="loans">
                            <h3 class="comm-title" style="padding-bottom: 1rem">Additional Items (if applicable)</h3>
                          </div>
                          ...
                          <div class="grid-x grid-margin-y">
                            ...
                            <div class="cell small-12 ">
                              <ul class="accordion" data-responsive-accordion-tabs="accordion" data-multi-expand="false" data-allow-all-closed="true">
                                ...
                                <li class=" accordion-item is-active" data-accordion-item="data-accordion-item" data-q2-deep-link-id="for-commercial-real-estate-loans-1013">
                                  <a href="#" class="accordion-title">
                                    <h2>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="accordion-tab-content">
                                      ...
                                      <ul>
                                        <li>Purchase Contract or Buy/Sell Agreement (Must include all exhibits and addenda)</li>
                                        <li>New Construction Budget or Contract</li>
                                        <li>Description of Real Estate</li>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="for-purchase-of-machinery-or-equipment-1014">
                                  <a href="#" class="accordion-title">
                                    <h2>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="accordion-tab-content">
                                      ...
                                      <ul>
                                        <li>Purchase order or invoice</li>
                                        <li>Detailed description and specifications of equipment to be purchased</li>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="for-refinancing-your-equipment-1015">
                                  <a href="#" class="accordion-title">
                                    <h2>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="accordion-tab-content">
                                      ...
                                      <ul>
                                        <li>Detailed list of equipment and machinery to be refinanced</li>
                                        <li>Serial Numbers</li>
                                        <li>Date of purchase or age of equipment</li>
                      ...
                      <div class="q2-section call-to-action-section primary gutter-none">
                        <div class="q2-wrap">
                          <p>Are our SBA products is a good fit for your business? </p>

                          <a href="sba-lending.php" class="button" aria-label="Learn More through our SBA Lending page">Learn More</a>
                      ...
                      <div class="q2-section general-section gutter-top ">
                        <div class="q2-wrap grid-container">
                          ...
                          <h2>Stay informed with articles written by <em><span class="blue">Beko Federal Credit Union (BEKOFCU)</span></em></h2>
                      ...
                      <div class="q2-section grid-section columns gutter-none">
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-6 large-4 column">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/column_start-your-own-business.jpg?VersionId=itPnqpsJ0q5OIGMiX27wDq0jtzL7m4GU" width="270" height="229" alt="Four paper airplanes " loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <a href="https://bekofcu.com/spendlifewisely/starting-your-own-business" class="button" aria-label="Starting Your Own Business blog page">Starting Your Own Business</a>
                            ...
                            <div class="cell small-12 medium-6 large-4 column">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/column_purchase-equipment.jpg?VersionId=YMOmRLPw.8Uyo6ct4_10QbYf.FcJ1pwQ" width="270" height="229" alt="Worker holding a cellphone and notebook inside a warehouse" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <a href="https://bekofcu.com/spendlifewisely/purchasing-equipment-your-business" rel="\" class="button" aria-label="Purchasing Equipment For Your Business blog page">Purchasing Equipment For Your Business</a>
                            ...
                            <div class="cell small-12 medium-6 large-4 column">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/column_access-to-cash.jpg?VersionId=o.aO.ViSswIfz1IxRw8LtL6I_9egXbLh" width="270" height="229" alt="One hand handing the other hand cash" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <a href="https://bekofcu.com/spendlifewisely/access-cash-working-capital" class="button" aria-label="Access to Cash with Working Capital blog page">Access to Cash with Working Capital </a>
                      ...
                      <div class="q2-section uneven-section gutter-bottom">
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-5">
                              ...
                              <div class="button-container">
                                ...
                                <a href="spendlifewisely-overview.php" class="button" aria-label="Spend Life Wisely blog page">Spend Life Wisely</a>
