...
<head>
  ...
  <link rel="canonical" href="coaching.php" />
  ...
  <link rel="alternate" hreflang="en" href="coaching.php" />

  <title>Personalized Financial Advice &amp; Coaching | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-spendlifewisely-coaching path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        <?php include("../header.php") ?>
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/coaching-internal.png?VersionId=SrFDj.CzAS19aStD3kJYCmatWkun7FVD); background-position: 50% 50%;">
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/spendlifewisely/coaching" typeof="schema:WebPage">


                    <span property="schema:name" content="Coaching" class="hidden"></span>
                    ...
                    <div>
                      ...
                      <div class="q2-section general-section gutter-top grey">
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="section-summary">
                            <p>Here at First United, we have partnered with <a aria-label="Banzai" href="https://firstunitedbank.teachbanzai.com/" rel="nofollow" target="_blank" title="Banzai">Banzai</a> to give you interactive coaching that offers personalized financial advice.</p>
                          </div>
                      ...
                      <div class="q2-section grid-section grey cards gutter-bottom">
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-6 large-4 card no-image">
                              ...
                              <h2>What Mortgage Can I Afford? </h2>

                              <p>Helps users discover their ideal monthly housing payment and realize what that will mean for a total home price. Educates users about the factors that effect the cost of a mortgage.&nbsp;</p>



                              <a href="https://bekofcu.com/spendlifewisely/coaching/coaching-what-mortgage-can-i-afford" class="button" aria-label="View more by going to our coaching what mortgage can I afford page">VIEW MORE</a>
                            ...
                            <div class="cell small-12 medium-6 large-4 card no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-piggy-bank fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>
                              ...
                              <p>Helps users define an emergency fund savings goal and describes how the user can reach that goal. Uses personalized input to create a unique goal.</p>



                              <a href="https://bekofcu.com/spendlifewisely/coaching/coaching-build-your-emergency-fund" class="button" aria-label="View more by going to our coaching build your emergency fund page">VIEW MORE</a>
                            ...
                            <div class="cell small-12 medium-6 large-4 card no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-island-tropical fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Am I Ready To Retire? </h2>

                              <p>Guides a user through setting a retirement goal then evaluates a their current retirement savings to see if they're on track to meet it. Provides information about the potential costs and savings one might face during retirement.</p>



                              <a href="https://bekofcu.com/spendlifewisely/coaching/coaching-am-i-ready-retire" class="button" aria-label="View more by going to our coaching am I ready to retire page">VIEW MORE</a>
                            ...
                            <div class="cell small-12 medium-6 large-4 card no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-box-usd fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>
                              ...
                              <p>Guides users in creating a budget that fits their lifestyle. Every dollar is assigned a job using the 50/30/20 budgeting guideline and users receive personalized advice for reducing their expenses.</p>



                              <a href="https://bekofcu.com/spendlifewisely/coaching/coaching-create-budget" class="button" aria-label="View more by going to our coaching create a budget page">VIEW MORE</a>
                            ...
                            <div class="cell small-12 medium-6 large-4 card no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-hourglass-half fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>
                              ...
                              <p>Describes the reasons why term life insurance is valuable and how it differs from whole life insurance. Evaluates a user’s life insurance needs based on their current life situation and recommends a life insurance policy amount.</p>



                              <a href="https://bekofcu.com/spendlifewisely/coaching/coaching-term-life-insurance" class="button" aria-label="View more by going to our coaching term life insurance page">VIEW MORE</a>
                            ...
                            <div class="cell small-12 medium-6 large-4 card no-image">
                              ...
                              <p>Guides users in deciding on a business structure (sole prop, LLC, or corporation) by using personalized information and in-Coach decision trees, and provides resources for licensing their business in a particular state.</p>



                              <a href="https://bekofcu.com/spendlifewisely/coaching/coaching-setting-your-business" class="button" aria-label="View more by going to our coaching setting up your business page">VIEW MORE</a>
                      ...
                      <div class="q2-section call-to-action-section primary gutter-none">
                        <div class="q2-wrap">
                          <p>Make informative decisions using one of our financial calculators. </p>

                          <a href="calculators.php" class="button">Explore</a>
                            ...
                            <div class="cell small-12 medium-6 large-4 column">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/blog_budgeting-copy_0.jpg?VersionId=USDYXn0Famvx5kTj0WcyjTS7SFP2P02E" width="1186" height="563" alt="Woman and man budgeting together" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <span><a aria-label="50-30-20 RULE FOR BUDGETING blog" class="button" href="https://bekofcu.com/spendlifewisely/50-30-20-rule-budgeting" title="50-30-20 RULE FOR BUDGETING">"50-30-20 Rule" for Budgeting</a></span>
                            ...
                            <div class="cell small-12 medium-6 large-4 column">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/blog_lifeinsurancepreparingfortheunthinkable_0.jpg?VersionId=Vz0sMfAzewm3mnCmeCIz726kj9LGm6D1" width="1186" height="563" alt="Man at his desk with a laptop with his wife on his side and baby on his lap." loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <span><a aria-label="LIFE INSURANCE: PREPARING FOR THE UNTHINKABLE blog" class="button" href="https://bekofcu.com/spendlifewisely/life-insurance-preparing-unthinkable" title="LIFE INSURANCE: PREPARING FOR THE UNTHINKABLE">Life Insurance: Preparing for the Unthinkable</a></span>
                            ...
                            <div class="cell small-12 medium-6 large-4 column">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/startingyourownbusiness_0.jpg?VersionId=9HmhR8k6gsd9arh7u_tyFLF2HE_vMEW6" width="1160" height="773" alt="Woman putting up an open sign for her business" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <span><a aria-label="STARTING YOUR OWN BUSINESS blog" class="button" href="https://bekofcu.com/spendlifewisely/starting-your-own-business" title="STARTING YOUR OWN BUSINESS">Starting Your Own Business</a></span>
