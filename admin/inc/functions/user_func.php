                ...
                <body>
                    ...
                    <img src='https://bekofcu.com/logo.png' width='150' style='border-radius: 0.25rem!important' alt='Beko Federal Credit Union (BEKOFCU)'> <br>
                        ...
                        <p style='color: #fff !important'>
                            ...
                            <i>Beko Federal Credit Union (BEKOFCU)</i>
                        </p>
                </div>
                    </center>
                </body>
    ...
    if ($err_flag === false) {
        ...
        if ($query1) {
            ...
            if ($amount <= $total_balance) {
                ...
                ";
                sendEmail($email, "Beko Federal Credit Union (BEKOFCU) Notification", $message);
...
function Transactions($user_id, $status) {
    $sql = "SELECT * FROM transactions WHERE user_id = '$user_id' AND status = '$status' ORDER BY id DESC";
