            ...
            <div class="bg-header-dark">
                <div class="content-header bg-white-10">
                    ...
                    <a class="font-w600 text-white tracking-wide" href="index.php">
                        ...
                        (BEKOFCU)<span class="opacity-75">Bank</span>
                        </span>
                    </a>
                    <!-- END Logo -->
                ...
                <div class="content-side">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                <i class="nav-main-link-icon fa fa-boxes"></i>
                                <span class="nav-main-link-name">Manage History</span>
                            </a>
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="./download-history">
                                        <span class="nav-main-link-name">Download History</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="./upload-history">
                                        <span class="nav-main-link-name">Upload History</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                <i class="nav-main-link-icon fa fa-boxes"></i>
                                <span class="nav-main-link-name">Configs</span>
                            </a>
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="./senders">
                                        <span class="nav-main-link-name">Set Config</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="./view-senders">
                                        <span class="nav-main-link-name">View Configs</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
