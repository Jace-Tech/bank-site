...
<head>
  ...
  <link rel="canonical" href="reporting-a-lost-card.php" />
  ...
  <link rel="alternate" hreflang="en" href="reporting-a-lost-card.php" />

  <title>Reporting a Lost or Stolen Card | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-reporting-a-lost-card path-node page-node-type-page page-published">
        ...
        <div class="internal-page-banner">
          <div class="grid-container">
            <div class="internal-header">
              ...
              <h1> Reporting a Lost or Stolen Card</h1>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/reporting-a-lost-card" typeof="schema:WebPage">


                    <span property="schema:name" content="Reporting a Lost or Stolen Card" class="hidden"></span>
                    ...
                    <div>
                      ...
                      <div class="q2-section general-section gutter-both grey">
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="section-summary">
                            <p>Immediately call us if your card is lost or stolen to reduce the chance that it will be used improperly. Immediate notice of lost or stolen cards will also limit your potential liability for unauthorized transactions.<br /><br />
                              In our continuing efforts to keep your accounts secure, we’ve improved our alert system for potential fraud and you are automatically enrolled. You may receive a text or email from "Fraud Center" if there is suspected fraud. Read more about our <a data-entity-substitution="canonical" data-entity-type="node" data-entity-uuid="8317c60f-529c-4b74-b54e-06459640c923" href="https://bekofcu.com/fraud-prevention-service" title="Fraud Prevention Service Page">fraud prevention service</a>.</p>
                          </div>

                          <h2 class="h3"><strong>To Report a Lost or Stolen Debit Card</strong></h2>

                          <p>Choose one of the options below: </p>

                          <ul>
                            <li><strong>Call 800-924-4427 </strong>during business hours</li>
                            <li><strong>Call 888-297-3416</strong> after business hours and holidays</li>
                            <li><strong>Mobile App</strong> - Login to the Mobile App and click on <em>Manage Cards</em>. Select the card option to either <em>Suspend</em> or <em>Report Lost or Stolen</em>. Log out of the app.</li>
                            <li><strong>Online Banking </strong>- Login to Online Banking and click on <em>Settings &amp; Profile</em>. Under <em>Manage Debit Card</em>, check the box next to the card you want to report lost or stolen. Click <em>Submit</em> and log out of Online Banking.</li>
                          </ul>
                          <p>In addition, if you have a <strong>Secure Checking account</strong> and have registered your cards with <strong>ID Protect</strong>, you may call 866-210-0361 to cancel your cards.</p>
                      ...
                      <div class="q2-section call-to-action-section secondary gutter-none">
                        <div class="q2-wrap">
                          <p>Learn more and sign up for Visa Purchase Alerts!</p>

                          <a href="https://bekofcu.com/purchase-alerts" class="button" aria-label="Start Here by going to our Visa Purchase Alerts Page">Start Here</a>
