...
<head>
  ...
  <link rel="canonical" href="direct-deposit.php" />
  ...
  <link rel="alternate" hreflang="en" href="direct-deposit.php" />

  <title>Direct Deposit | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-direct-deposit path-node page-node-type-page page-published">
        ...
        <div class="internal-page-banner">
          <div class="grid-container">
            ...
            <div class="banner-button">
              <p>Sign up for direct deposit today and spend time on the things that matter most!</p>

              <a href="https://q2-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/document/directdeposit_2015.pdf?rQK0CzFPgq4zVxG_DEkVrLIPOJ7SiZKW=" target="_blank" rel="nofollow" class="button" aria-label="Download our direct deposit form">Download Form</a>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/direct-deposit" typeof="schema:WebPage">


                    <span property="schema:name" content="Direct Deposit" class="hidden"></span>
                    ...
                    <div>
                      ...
                      <div class="q2-section general-section gutter-both ">
                        <div class="q2-wrap grid-container">
                          ...
                          <h2>Save time with Direct Deposit from Beko Federal Credit Union (BEKOFCU)!</h2>

                          <p>&nbsp;</p>

                          <div class="section-summary">
                            <p>Never worry about getting to the bank to make a deposit on payday. With direct deposit, relax and enjoy knowing that your account has already been credited.<br />
                              <br />
                              Direct deposit is the safest and most convenient way for deposits to be made each pay period. Deposits are made electronically and setup through your employer, pension plan administrator, or the Social Security Administration.<br />
                              <br />
                      ...
                      <div class="q2-section general-section gutter-top grey">
                        <div class="q2-wrap grid-container">
                          ...
                          <h2>Locate your Routing Number and Account Number.</h2>

                          <div class="align-center media-image">

                            <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/checkoutline-nowords-copy.png?VersionId=5hhC0wc0E2O1kbDpLCA0ZFSLoXBCh2Q1" width="600" height="250" alt="check outline sample with no words" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                          </div>
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                            <div class="cell small-12 medium-7">
                              ...
                              <div id="direct-deposit">
                                <ol type="a">
                                  <li><span class="dark-blue uppercase"><strong>Bank routing transit number (RTN):</strong></span><br />
                                    <span class="black">This is the nine-digit number on the bottom left-hand corner of your checks, to the left of your account number.</span>
                                  </li>
                                  <li><span class="dark-blue uppercase"><strong>Account number:</strong></span><br />
                                    <span class="black">This 10-13 digit number is unique to your account. You will need it to set up direct deposit. You can also find this information on your account opening documents or account statement.</span>
                                  </li>
                                </ol>
                              </div>
                            ...
                            <div class="cell small-12 medium-5">
                              ...
                              <div id="direct-deposit">
                                <table border="1" cellpadding="1" cellspacing="1">
                                  <thead>
                                    <tr>
                                      <th class="text-center uppercase" colspan="2" scope="row"><strong>Beko Federal Credit Union Routing Number(s)</strong></th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                    <tr>
                                      <td class="text-center dark-blue uppercase"><strong>Oklahoma</strong></td>
                                      <td>103100881</td>
                                    </tr>
                                    <tr>
                                      <td class="text-center dark-blue uppercase"><strong>Texas</strong></td>
                                      <td>111911321</td>
                                    </tr>
                                  </tbody>
                                </table>
                      ...
                      <div class="q2-section call-to-action-section secondary gutter-none">
                        <div class="q2-wrap">
                          <p>Already have direct deposit at another bank? Get Simple Switch!</p>

                          <a href="https://bekofcu.com/simple-switch" class="button">Start Here</a>
