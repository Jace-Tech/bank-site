...
<head>
  ...
  <link rel="canonical" href="digital-banking-personal.php" />
  ...
  <link rel="alternate" hreflang="en" href="digital-banking-personal.php" />

  <title>Manage Your Account with Mobile Banking | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-digital-banking-personal path-node page-node-type-page page-published">
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        ...
        <div class="internal-page-banner banner-img"
          style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/onlinemobilebanking-internal.png?VersionId=DkRxjH1aABHVciQhyXmNCF17gtq27Suz); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">


              <h1> Online &amp; Mobile Personal Banking</h1>
              <p>Beko Federal Credit Union makes it even easier to manage your personal accounts safely and conveniently
                with our Online & Mobile Banking<sup>1</sup>.</p>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/digital-banking-personal" typeof="schema:WebPage">


                    <span property="schema:name" content="Online &amp; Mobile Personal Banking" class="hidden"></span>
                    ...
                    <div>
                            ...
                            <div class="cell small-12 medium-6 large-4 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img
                                    src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/card-seamlessaccess-1.png?VersionId=G6qVVwSwHrGmcSUxQkHViHTP0wBrQdUV"
                                    width="350" height="250" alt="Happy girl sitting on couch and working on tablet"
                              ...
                              <a href="/user/signup?_ga=2.114551623.1949952734.1623687799-1381044293.1617314869&amp;_gac=1.121383674.1621626996.CjwKCAjwtJ2FBhAuEiwAIKu19jwE1K7OUnhI0Eil8xcbxJYuqLHRKoG4QVM77CtAriFniGjFAQpOwBoC1gMQAvD_BwE"
                            ...
                            <div class="cell small-12 medium-6 large-4 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img
                                    src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/card-managedebitcard-1_0.png?VersionId=fkXkV1PVN6tHpXwIiFyQAD3i847XTUXa"
                                    width="350" height="250" alt="One hand on credit card and the other on laptop"
                                    loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <div id="online-mobile-banking">&nbsp;
                                <ul class="fa-ul icons-indent">
                                  <li><span class="fa-li"><i class="fas fa-check-circle fa-lg blue">&nbsp;</i></span>
                                    <p><strong>Manage debit cards and setup helpful activity alerts.</strong></p>
                                  </li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img
                                    src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/card-linkpersonalbanking-1-1.png?VersionId=IpPX8jfZt0_bUKIRRZwfTuRJy6LNbg64"
                                    width="350" height="250" alt="Happy woman and man on their smartphone"
                                    loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <div id="online-mobile-banking">&nbsp;
                                <ul class="fa-ul icons-indent">
                                  <li><span class="fa-li"><i class="fas fa-check-circle fa-lg blue">&nbsp;</i></span>
                                    <p><strong>Link Personal banking accounts to transfer money between friends and
                      ...
                      <div class="q2-section general-section gutter-both primary">
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="text-center" id="online-mobile-banking">
                            ...
                            <div class="section-summary">
                              <p>Convenience and security to manage all of your personal account needs, across any
                                device.</p>
                            </div>
                          </div>
                      ...
                      <div class="q2-section call-to-action-section secondary gutter-none">
                        <div class="q2-wrap">
                          <p>Learn tips about maintaining online security.</p>

                          <a href="online-security.php" class="button">Click Here</a>
