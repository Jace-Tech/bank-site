...
<head>
  ...
  <link rel="canonical" href="spendlifewisely-overview.php" />
  ...
  <link rel="alternate" hreflang="en" href="spendlifewisely-overview.php" />

  <title>Spend Life Wisely | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-spendlifewisely-overview path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <?php include("./header.php"); ?>
      <header>
        <?php include("./nav.php"); ?>
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/banner-internal-slw.png?VersionId=DcBmLEBYZk6K0RqlEQ7aGaqIQ3IRE.FD); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">


              <h1> What will you do with your one, precious life?</h1>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/spendlifewisely-overview" typeof="schema:WebPage">


                    <span property="schema:name" content="What will you do with your one, precious life?" class="hidden"></span>
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                            <div class="cell small-12 medium-7">
                              ...
                              <div class="section-summary">&nbsp;
                                <p>We are each blessed with an impressive balance sheet of life moments to spend, and to cherish. To help you make the most of your life's moments, Beko Federal Credit Union (BEKOFCU) is here with advice and tools to use along your journey as you realize your fullest potential. This is how we are changing the world - one customer, one family, one community at a time.</p>
                              </div>
                            ...
                            <div class="cell small-12 medium-5">
                              ...
                              <p><iframe allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" frameborder="0" height="315" src="https://www.youtube.com/embed/BgZEiXvlaRU?rel=0&amp;autoplay=0&amp;mute=1" style="border-radius: 4px" title="YouTube video player"></iframe></p>
                        ...
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-y">
                            <div class="cell small-12 section-title">
                              <h2>Four Pillars: A Holistic Approach</h2>
                            </div>
                            <div class="section-summary">
                              <p>To truly Spend Life Wisely it takes a holistic approach that encompasses faith, financial well-being, health and wellness, and personal growth. We invite you to learn more about the Four Pillars and how to bring each into your daily routine. </p>
                            </div>
                            <div class="cell small-12 ">
                              <ul class="tabs" data-responsive-accordion-tabs="accordion medium-tabs large-tabs" data-multi-expand="false" data-allow-all-closed="true">
                                ...
                                <li class=" accordion-item is-active" data-accordion-item="data-accordion-item" data-q2-deep-link-id="faith-2307">
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    ...
                                    <div class="accordion-tab-content">
                                      ...
                                      <a href="https://bekofcu.com/spendlifewisely/category/faith" class="align-right button" aria-label="Explore Faith Pillar">Explore</a>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="financial-well-being-2310">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    ...
                                    <div class="accordion-tab-content">
                                      ...
                                      <a href="https://bekofcu.com/spendlifewisely/category/financial%20well-being" class="align-right button" aria-label="Explore Financial Well-Being pillar">Explore</a>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="health-2309">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    ...
                                    <div class="accordion-tab-content">
                                      ...
                                      <a href="https://bekofcu.com/spendlifewisely/category/health%20and%20wellness" class="align-right button" aria-label="Explore Personal Growth Pillar">Explore</a>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="growth-2308">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    ...
                                    <div class="accordion-tab-content">
                                      ...
                                      <a href="https://bekofcu.com/spendlifewisely/category/personal%20growth" class="align-right button" aria-label="Explore the Personal Growth pillar">Explore</a>
                            ...
                            <div class="cell small-12 medium-6 large-4 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/card-blog-1.png?VersionId=JcQwTQ931ortgLQRuqU3cbSjl5gMFcyB" width="360" height="171" alt="Happy woman on laptop" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <h3>Articles, Tips & Advice</h3>

                              <p>You have unlimited access to an entire library of over 200 articles and blog entries that provide insights and tips on everything from healthy eating to money management to exploring your faith.</p>



                              <a href="spendlifewisely.php" class="button" aria-label="View all blogs">VIEW ALL</a>
                            ...
                            <div class="cell small-12 medium-6 large-4 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/card-calculators_1.png?VersionId=XLUaN_BSdSfPDYRMl9R5JbB58hYCi5h." width="360" height="171" alt="Calculator with graph" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <p>Need help with numbers? With just a few clicks, these easy-to-use online calculators can help you better things like budgeting, mortgage affordability and saving for retirement.&nbsp;</p>



                              <a href="spendlifewisely/calculators.php" class="button" aria-label="View all Calculators resources">VIEW ALL</a>
                            ...
                            <div class="cell small-12 medium-6 large-4 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/card-coaching_1.png?VersionId=dgxhx4JWyaYsRW38OkR7hkr5bZT90hTQ" width="360" height="171" alt="Coaching preview" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <p>Enjoy free interactive coaching and seminars that cover topics like setting up your new business, getting ready for retirement or reducing debt.</p>



                              <a href="spendlifewisely/coaching.php" class="button" aria-label="View all Coaching resources">VIEW ALL</a>
              ...
              <div class="footer-menu cell small-12 large-auto large-grow">
                <nav class="menu-wrapper" id="footer-menu">
                  <ul>
                    ...
                    <li>
                      <a class="active" href="spendlifewisely-overview.php">Spend Life Wisely</a>
