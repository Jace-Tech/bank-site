...
<head>
  ...
  <link rel="canonical" href="certificate-deposit.html" />
  ...
  <link rel="alternate" hreflang="en" href="certificate-deposit.html" />

  <title>Certificate of Deposit (CD) | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-certificate-deposit path-node page-node-type-page page-published">
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        ...
        <div class="internal-page-banner banner-img"
          style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/cds-internal.png?VersionId=mRzWF_iZG8nrsXVdpTqHqlab9zqoB8yo); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">


              <h1> Certificate of Deposit (CD)</h1>
              <p>A certificate of deposit (CD) is a low-risk investment that may offer you a better return on your money
                than traditional savings accounts while still being backed by the security of FDIC insurance. We invite
                you to learn more by speaking with a Beko Federal Credit Union (BEKOFCU)er. </p>

            </div>

            <div class="banner-button">
              <p>Contact your community bank.</p>

              <a href="locations.php" class="cd1 button" aria-label="START HERE by going to the locations page. ">START
                HERE</a>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/certificate-deposit" typeof="schema:WebPage">


                    <span property="schema:name" content="Certificate of Deposit (CD)" class="hidden"></span>
                    ...
                    <div>
                      ...
                      <div class="q2-section call-to-action-section secondary gutter-none">
                        <div class="q2-wrap">
                          <p>Earn 2X<sup>*</sup> More than similar CDs<sup>3</sup> with this limited time offer. </p>

                          <a href="https://bekofcu.com/cdoffer" class="button"
                            aria-label="Learn more by going to our CD Offer page">Learn More</a>
                      ...
                      <div class="q2-section general-section gutter-top grey">
                        <div class="q2-wrap grid-container">
                          ...
                          <h2>Help grow your savings with a CD.&nbsp;</h2>

                          <div class="section-summary">
                            <p><br />
                              Whether you’re looking to invest for a few months or a few years, a Certificate of Deposit
                              (CD)&nbsp;from Beko Federal Credit Union may be right for you. We offer competitive rates
                              and investment account options to support you along your financial journey. Start a
                              conversation with us today to learn more.</p>
                          </div>
                      ...
                      <div class="q2-section grid-section grey callouts gutter-bottom">
                        <div class="q2-wrap grid-container">
                            ...
                            <div class="cell small-12 medium-6 large-4 callout">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img
                                    src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/callout-getstarted-2.png?VersionId=Ecx_1uPKk9Cv3ztpO3KMiN73vGEAkn8E"
                                    width="362" height="500" alt="Couple on the computer together" loading="lazy"
                              ...
                              <p>Open your account with a $500 deposit.</p>
                            ...
                            <div class="cell small-12 medium-6 large-4 callout">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img
                                    src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/callout-0monthly-copy.png?VersionId=62OvD99shJyJ4po_MPSBVcgPQcn9ZkOo"
                                    width="362" height="500" alt="Happy senior man on laptop" loading="lazy"
                                    typeof="foaf:Image" class="img-fluid" />
                              ...
                              <h2>Guaranteed Rate</h2>

                              <p>Your rate is locked-in for the life of the CD.</p>
                            ...
                            <div class="cell small-12 medium-6 large-4 callout">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img
                                    src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/callout-onlinemobilebanking-copy.png?VersionId=.7s2G5ZIa4jXcm2nWzEHdEfpAta.3zSE"
                                    width="362" height="500" alt="Happy woman on laptop" loading="lazy"
                                    typeof="foaf:Image" class="img-fluid" />
                              ...
                              <p>Bank on your terms. Anytime, anywhere.&nbsp;</p>
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-5">
                              ...
                              <div class="button-container">
                                <span class="lead-text">Contact your community bank.</span>

                                <a href="locations.php" class="cd2 button"
                                  aria-label="START HERE by going to the locations page. ">START HERE</a>
                      ...
                      <div class="q2-section general-section gutter-top ">
                        <div class="q2-wrap grid-container">
                          ...
                          <h2>Options to invest in your future.&nbsp;</h2>

                          <div class="section-summary">
                            <p><br />
                              We know financial well-being isn’t just about having more money. It’s about having
                              financial peace and security and reaching for the goals that are important to you.</p>
                          </div>
                      ...
                      <div class="q2-section grid-section columns gutter-bottom mobile-center">
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-x grid-margin-y">
                              ...
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-laptop fa-lg" data-fa-transform="" data-fa-mask=""
                                      style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Online & Mobile Banking<sup>1,2</sup></h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-coins fa-lg" data-fa-transform="" data-fa-mask=""
                                      style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-fingerprint fa-lg" data-fa-transform="" data-fa-mask=""
                                      style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>
                              ...
                              <h2>Touch/Face ID Mobile Banking</h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-file-pdf fa-lg" data-fa-transform="" data-fa-mask=""
                                      style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>
                      ...
                      <div class="q2-section v-tabs-section grey gutter-both">
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-y">
                            <div class="cell small-12 section-title">
                              <h2>A different kind of bank.</h2>
                            </div>
                            <div class="section-summary">
                              <p>Beko Federal Credit Union (BEKOFCU) is a financial services organization dedicated to
                                helping you protect and make the most of your assets. But we’re a lot more than that.
                                Banking and finance are what we do, not who we are. We invite you to discover what makes
                                us unique. </p>
                            </div>
                            <div class="cell small-12 v-tabs">
                              <ul class="v-tabs vertical"
                                data-responsive-accordion-tabs="accordion medium-tabs large-tabs"
                                data-multi-expand="false" data-allow-all-closed="true">


                                <li class=" accordion-item is-active" data-accordion-item="data-accordion-item"
                                  data-q2-deep-link-id="driven-by-value-484">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                                          <i class="fas fa-dove" data-fa-transform="" data-fa-mask=""
                                            style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                        </div>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="panel-bg-image">
                                      <img
                                        src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/accoustic_drivebyvalues.jpg?VersionId=RpJooml.pZM4ExscB8Ptla9j.vT1YWTR"
                                        alt=" background image" />
                                    </div>
                                    <div class="accordion-tab-content">

                                      <p>Extending LOVE. Making IMPACT. These are the values that drive our organization
                                        forward everyday and fuel us in supporting our customers</p>



                                      <a href="about-us.php" class="button" aria-label="Our Values">Our Purpose &amp;
                                        Values</a>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item"
                                  data-q2-deep-link-id="holistic-approach-485">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                                          <i class="fas fa-spa" data-fa-transform="" data-fa-mask=""
                                            style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                        </div>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="panel-bg-image">
                                      <img
                                        src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/accoustic_holisticapproach_0.jpg?VersionId=qxlKMM0CL33j4R6LTUnRrjHpSeT0usm8"
                                        alt=" background image" />
                                    </div>
                                    <div class="accordion-tab-content">

                                      <p>We exist to help you find your unique path to success. We believe success
                                        requires a balance of faith, financial well-being, health and personal
                                        growth.&nbsp;</p>



                                      <a href="spendlifewisely-overview.php" class="button"
                                        aria-label="Spend Life Wisely">Spend Life Wisely</a>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item"
                                  data-q2-deep-link-id="culture-of-care-486">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                                          <i class="fas fa-hand-holding-heart" data-fa-transform="" data-fa-mask=""
                                            style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                        </div>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="panel-bg-image">
                                      <img
                                        src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/accoustic_cultureofcare.jpg?VersionId=ZvZhCPcLR9EJpBVXUSgV9ZKF7SVZGwrH"
                                        alt=" background image" />
                                    </div>
                                    <div class="accordion-tab-content">

                                      <p>No two financial journeys are the same. We’ll meet you where you are, and help
                                        get you where you want to be. In business and in life.&nbsp;</p>



                                      <a href="contact-us.php" class="button" aria-label="Start a Relationship">Start a
                                        Relationship</a>
                      ...
                      <div class="q2-section uneven-section blue-pattern-top gutter-both">
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-x grid-margin-y">
                            <div class="cell small-12 medium-4">
                              ...
                              <div class="align-center media-image">
                                ...
                                <img
                                  src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/fubt-shield-large-spendnexchapterwisely-copy.png?VersionId=NcBcqJIFsPwB8E2hlU1SyDE0pTQG0x0n"
                                  width="320" height="364" alt="Happy senior couple " loading="lazy" typeof="foaf:Image"
                                  class="img-fluid" />
                              </div>
                            ...
                            <div class="cell small-12 medium-8">
                              ...
                              <div id="slw-section">
                                <h2>Spend <span class="slw-tag">your next chapter</span>&nbsp;Wisely. &nbsp;</h2>
                                &nbsp;

                                <p>This "Retirement Planning for Later in Life" webinar was recorded by the Financial
                                  Well-Being team at Beko Federal Credit Union (BEKOFCU) - Jennifer Henagar, Director of
                                  Financial Well-Being, and Lisa Crawford, Financial Well-Being Specialist.</p>
                              </div>
                              ...
                              <div class="button-container">
                                <span class="lead-text">Explore</span>

                                <a href="https://bekofcu.com/spendlifewisely/retirement-planning-later-life-webinar"
                                  class="button" aria-label="FINANCIAL WELL BEING">FINANCIAL WELL BEING</a>
                      ...
                      <div class="q2-section general-section gutter-both grey">
                        <div class="q2-wrap grid-container">
                          ...
                          <div id="disclosure">
                            <p>*&nbsp; Compared to the current rate for a Beko Federal Credit Union (BEKOFCU) 12-Month
                              CD as of August 24, 2022</p>

                            <p>1&nbsp; Message and data rates may apply. Such charges include those from your
                              communications service provider.</p>

                            <p>2&nbsp; Registration/Activation Required.</p>

                            <p>3&nbsp; Annual Percentage Yield (APY) is effective as of August 24, 2022, and subject to
                              change at any time without notice. CD rates are fixed upon opening the account. A minimum
                              balance of $10,000 required to open the account and earn interest. At least 50% of the
                              opening deposit amount must be “new money” to Beko Federal Credit Union (BEKOFCU). New
                              money is defined as funds not deposited with Beko Federal Credit Union (BEKOFCU) within
                              the last 60 days. Offer not available to businesses, collateralized deposits, public
                              funds, IRAs, or brokered deposits. Penalties may be imposed for early withdrawals. Fees
                              may affect earnings.</p>
                          </div>
