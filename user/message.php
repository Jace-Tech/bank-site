                ...
                <ul class="nav-main-submenu">
                  ...
                  <li class="nav-main-item open">
                    ...
                    <ul class="nav-main-submenu">
                      ...
                      <li class="nav-main-item">
                        <a class="nav-main-link active" href="be_pages_forum_discussion.html">
              ...
              <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-alt">
                  <li class="breadcrumb-item">
                    <a class="link-fx text-dark" href="be_pages_forum_categories.html">Forum</a>
                  </li>
                  <li class="breadcrumb-item">
                    <a class="link-fx text-dark" href="be_pages_forum_topics.html">Topics</a>
                  </li>
