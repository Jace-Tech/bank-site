					...
					<div class="block-content">
						...
						<div class="table-responsive">
							<table class="table table-borderless table-striped table-vcenter">
								...
								<tbody>
									<?php
									$all_transactions = mysqli_fetch_all(returnQuery("SELECT * FROM transactions WHERE user_id = '$user_id' AND is_credit = 0 AND status = 'pending' ORDER BY created_at DESC"), MYSQLI_ASSOC);
