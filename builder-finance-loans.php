...
<head>
  ...
  <link rel="canonical" href="builder-finance-loans.php" />
  ...
  <link rel="alternate" hreflang="en" href="builder-finance-loans.php" />

  <title>Builder Finance Loans¹ | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-builder-finance-loans path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <?php include("./header.php"); ?>
      <header>
        <?php include("./nav.php"); ?>
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/builder-finance-internal.png?VersionId=SegjC9HR0Hb3ajH_Sd4EDRre7tlwoZit); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">


              <h1> Builder Finance Loans¹</h1>
              <p>Beko Federal Credit Union (BEKOFCU) is committed to helping our customers find their path to success and we believe this starts with establishing new communities.</p>
            ...
            <div class="banner-button">
              ...
              <a href="contact-us.php" class="no-new-window button" aria-label="Contact Us by going to our contacts page">Start Here</a>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/builder-finance-loans" typeof="schema:WebPage">


                    <span property="schema:name" content="Builder Finance Loans¹" class="hidden"></span>
                      ...
                      <div class="q2-section general-section gutter-top ">
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="section-summary">
                            <p>Our Builder Finance Group targets large and small residential builders and developers in Oklahoma and Texas. We're quickly becoming one of the most active lenders to the most reputable construction companies in these areas. We have a cadre of specialists inside and outside of the bank who have dedicated their careers to making homebuilding and residential land development easier.<br />
                              <br />
                      ...
                      <div class="q2-section general-section gutter-none ">
                        <div class="q2-wrap grid-container">
                          ...
                          <div id="loans">
                            ...
                            <div class="section-summary">&nbsp;
                              <p>First United's Builder Finance Group specializes in financing "for sale" housing builders and developers. This includes custom and volume homebuilders, and residential developers.<br />
                                <br />
                            ...
                            <div class="cell small-12 medium-6 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/cards_entitled-raw-land_560x229-copy.png?VersionId=VNPFbiZhN2ocGhz.AJwOnZJFro.6yv5j" width="560" height="229" alt="beautiful skies and fields" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <div id="loans">&nbsp;
                                <ul class="fa-ul icons-indent">
                                  <li><span class="fa-li"><i class="fas fa-check-circle fa-lg blue">&nbsp;</i></span>
                                    <p><strong>Entitled Raw Land</strong></p>
                                  </li>
                                  <li>
                                    <p>We get it. Gaining the legal right to develop a property for your chosen use takes time and involves a number of government agencies. While waiting for the moment when you can put a shovel in the ground you need bridge financing to keep operations moving so that you can begin making the return on your initial investment. We can help with a loan structured around your situation. It's not a "one size fits all" solution. It takes understanding your investment and the steps needed to get your project started.</p>
                                  </li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/cards_land-acqusition-and-development_560x229-copy_0.png?VersionId=T7XI7rdH_Z_pzh7kUtcdfJWUSP8nXvR9" width="560" height="229" alt="Trucks on land" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <div id="loans">&nbsp;
                                <ul class="fa-ul icons-indent">
                                  ...
                                  <li>
                                    <p>First United's Builder Finance Group finances land development to single family residential lot developers and homebuilders that develop their own lots. The structure of these loans is designed specifically to meet the developer where they are. We consider the housing product-type, the expected absorption, and the structure of builder contracts. We will also finance entitled raw land. Our advance rates and pricing are competitive.</p>
                                  </li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/cards_finished-developed-lots_560x229-copy.png?VersionId=CPlWz5VkrWnT5SbrPvxFFpyDRWa4maNz" width="560" height="229" alt="plot map" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                            ...
                            <div class="cell small-12 medium-6 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/cards_interim-construction_560x229-copy.png?VersionId=tKMkv.PMWe9bvZXZwfxYE1R5ert_9y7x" width="560" height="229" alt="Tw construction workers " loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <div id="loans">&nbsp;
                                <ul class="fa-ul icons-indent">
                                  <li><span class="fa-li"><i class="fas fa-check-circle fa-lg blue">&nbsp;</i></span>
                                    <p><strong>Interim Construction</strong></p>
                                  </li>
                                  <li>
                                    <p>First United's Builder Finance Group offers construction financing for all "for sale" single and detached housing projects. This includes single family detached homes, townhomes, and low-rise condominiums. Loan facilities include guidance and committed construction revolvers, borrowing base revolvers, all containing sublimits that balance risk and reward. The sublimits allow for models, speculative units, and finished developed lots. Draws and inspections are handled by industry specialists and funded as frequently as the clients prefers. Our loan pricing is competitive. The structure of these facilities is designed to support our builder's style of construction.</p>
                                  </li>
                                </ul>
                              </div>
