...
<head>
  ...
  <link rel="canonical" href="investment-management.php" />
  ...
  <link rel="alternate" hreflang="en" href="investment-management.php" />

  <title>Investment Management | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-investment-management path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        <?php include("./nav.php"); ?>
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/investments-internal.png?VersionId=ejRETFJmftg_EGaCyhVPYF5llgtwIlwk); background-position: 50% 50%;">
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/investment-management" typeof="schema:WebPage">


                    <span property="schema:name" content="Investment Management" class="hidden"></span>
                      ...
                      <div class="q2-section general-section gutter-both ">
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="section-summary">
                            <p>Our Beko Federal Credit Union Investment Services can create an investment plan just for you or we can evaluate your current investment plan, assess your progress toward important goals such as retirement and college savings and realign your portfolio, if needed.<br />
                              <br />
                              If you have married, remarried, or divorced - or welcomed a new member to the family - we can make certain your plan accounts for the obligatory beneficiary changes or discuss college planning. Changes in employment or caring for an elderly parent can also affect your investment plan.<br />
                              <br />
                              Its important to review your investment portfolio periodically and make sure that your current asset allocation is aligned with your goals and risk tolerances.<br />
                              <br />
                              Our professionals work for you with your best interest in mind.
                            </p>
                          </div>
