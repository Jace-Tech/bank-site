...
<head>
  ...
  <link rel="alternate" hreflang="en" href="about-us.php" />

  <title>About Us - Our Purpose, Values &amp; Vision | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-about-us path-node page-node-type-page page-published">
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        ...
        <div class="internal-page-banner banner-img"
          style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/about-us2-internal.png?VersionId=3dAQIpvpaHJV84AL0ZDd3Z0tQDkQd968); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">
              <h1> About Us</h1>
              <p>Beko Federal Credit Union is not your typical bank. We are driven by a higher purpose and guided by a
                core set of values that inspire us to serve all of our stakeholders.</p>
            </div>
          </div>
        </div>
      </header>
            ...
            <section class="cell small-12">
              <div>
                <div id="block-firstunitedbank-content">
                  <article role="article" about="/about-us" typeof="schema:WebPage">
                    <span property="schema:name" content="About Us" class="hidden"></span>
                    <div>
                      <div class="q2-section uneven-section none gutter-both">
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                            <div class="cell small-12 medium-4">
                              ...
                              <div class="align-center media-image">
                                ...
                                <img
                                  src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/fubt-shield-large-ourpurpose-copy.png?VersionId=nXxjJipKUF37NI2x6FRnAa0.XR0l7Jzb"
                                  width="320" height="364" alt="FUB shield large Our Purpose" loading="lazy"
                            ...
                            <div class="cell small-12 medium-8">
                              ...
                              <div id="about-us-purpose">
                                <div class="statement">
                                  <div class="section-summary">
                                    <p>To inspire and empower others to</p>
                                  </div>

                                  <div class="statement2">
                                    <p>Spend Life Wisely</p>
                                  </div>
                                </div>
                              </div>
                      ...
                      <div class="q2-section tabs-section blue-pattern-bottom gutter-both">
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-y">
                            ...
                            <div class="cell small-12 ">
                              <ul class="tabs" data-responsive-accordion-tabs="accordion medium-tabs large-tabs"
                                ...
                                <li class=" accordion-item is-active" data-accordion-item="data-accordion-item"
                                  data-q2-deep-link-id="extending-love.-835">
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="panel-bg-image">
                                      <img
                                        src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/accordian_extending-love-copy.png?VersionId=ZW4fks8J2R_zkQNnK25zHsvct5AYY3Ab"
                                        alt=" background image" />
                                    </div>
                                    <div class="accordion-tab-content">

                                      <div class="text-center" id="about-us-values"><i
                                          class="fas fa-heart fa-2x blue">&nbsp;</i>
                                        <h4 class="MsoNormal" style="line-height: 150%;"><span lang="EN">FAITH</span>
                                        </h4>

                                        <p class="MsoNormal" style="line-height:150%"><span lang="EN">We put God first,
                                            family second and work third.<br />
                                            <br />
                                            <o:p></o:p>
                                          </span></p>
                                        <i class="fas fa-home fa-2x blue">&nbsp;</i>

                                        <h4 class="MsoNormal" style="line-height: 150%;"><span lang="EN">FAMILY</span>
                                        </h4>

                                        <p class="MsoNormal" style="line-height:150%"><span lang="EN">We cherish our
                                            own, our work family, and the families of others.<br />
                                            <br />
                                            <o:p></o:p>
                                          </span></p>
                                        <i class="fas fa-handshake fa-2x blue">&nbsp;</i>

                                        <h4 class="MsoNormal" style="line-height: 150%;"><span
                                            lang="EN">INTEGRITY</span></h4>

                                        <p class="MsoNormal" style="line-height:150%"><span lang="EN">We do what’s
                                            right.</span></p>
                                      </div>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item"
                                  data-q2-deep-link-id="making-an-impact.-836">
                                  <a href="#" class="accordion-title">
                                    <h2>
                                      Making an IMPACT.
                                    </h2>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="panel-bg-image">
                                      <img
                                        src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/accordian_making-an-impact2-copy.png?VersionId=fmZ.WK8ypJpTHAPmzPfy1qQFJ9gwKuyU"
                                        alt=" background image" />
                                    </div>
                                    <div class="accordion-tab-content">

                                      <div class="text-center" id="about-us-values"><i
                                          class="fas fa-book-reader fa-2x orange">&nbsp;</i>
                                        <h4 class="MsoNormal orange" style="line-height: 150%;"><span
                                            lang="EN">LEARNERS</span></h4>

                                        <p class="MsoNormal" style="line-height:150%"><span lang="EN">We are dedicated
                                            to a life of continuous improvement.<br />
                                            <br />
                                            <o:p></o:p>
                                          </span></p>
                                        <i class="fas fa-chart-line fa-2x orange">&nbsp;</i>

                                        <h4 class="MsoNormal orange" style="line-height: 150%;">HIGH PERFORMANCE</h4>

                                        <p class="MsoNormal" style="line-height:150%"><span lang="EN">We combine our
                                            individual talents and succeed together.<br />
                                            <br />
                                            <o:p></o:p>
                                          </span></p>
                                        <i class="fas fa-hands fa-2x orange">&nbsp;</i>

                                        <h4 class="MsoNormal orange" style="line-height: 150%;"><span
                                            lang="EN">SERVICE</span></h4>

                                        <p class="MsoNormal" style="line-height:150%"><span lang="EN">We build lifelong
                                            relationships and healthy communities.</span></p>
                                      </div>
                      ...
                      <div class="q2-section grid-section primary columns gutter-both">
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-6 large-4 column">
                              <div class="icon image">
                                <div class="media-image">

                                  <img
                                    src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/cards_10millionlives-copy.png?VersionId=KaM9kGNWsUcPuHVOibQI9ILNQZ7IUrS8"
                                    width="270" height="229" alt="Diverse headshot collage of people smiling"
                              ...
                              <div class="about-us-vision">
                                <p>We have elevated 10 million lives through Love and Impact by 2030.</p>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img
                                    src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/cards_customerexperience.png?VersionId=ey5vT.VyUBMZX5op91YfYMO2jmEO5oCR"
                                    width="270" height="229" alt="Hand holding a heart " loading="lazy"
                                    typeof="foaf:Image" class="img-fluid" />
                              ...
                              <div class="about-us-vision">
                                <p>We have delivered the very best customer and employee experience.</p>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img
                                    src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/cards_communityflourish.png?VersionId=Ulpz3wx1wmDcey2Lz_kKjej1wMEKUILY"
                                    width="270" height="229"
                                    alt="Shadows of group of people holding hands held high in the sun" loading="lazy"
                                    typeof="foaf:Image" class="img-fluid" />
                              ...
                              <div class="about-us-vision">
                                <p>We have created communities that flourish through continued mentorship of ourselves
                                  and others to Spend Life Wisely.</p>
                              </div>
                      ...
                      <div class="q2-section tabs-section blue-pattern-top gutter-both">
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-y">
                            ...
                            <div class="section-summary">
                              <p>To Spend Life Wisely, we must have a holistic approach to life that encompasses faith,
                                financial well-being, health, and personal growth. </p>
                            </div>
                            <div class="cell small-12 ">
                              <ul class="tabs" data-responsive-accordion-tabs="accordion medium-tabs large-tabs"
                                data-multi-expand="false" data-allow-all-closed="true">
                                ...
                                <li class=" accordion-item is-active" data-accordion-item="data-accordion-item"
                                  data-q2-deep-link-id="faith-830">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                                          <i class="fas fa-heart" data-fa-transform="" data-fa-mask=""
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="panel-bg-image">
                                      <img
                                        src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/pillartab_faith-copy.png?VersionId=Gb.spKMxUTfA9dtWiZrqwiTuW6aXqqHi"
                                        alt=" background image" />
                                    </div>
                                    <div class="accordion-tab-content">
                                      ...
                                      <p>Allow God to guide your heart to a life of meaning and purpose, putting Him at
                                        the center of everything you do, inspiring you to serve others with love and
                                        compassion.</p>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item"
                                  data-q2-deep-link-id="financial-well-being-831">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                                          <i class="fas fa-landmark" data-fa-transform="" data-fa-mask=""
                                            style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                        </div>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="panel-bg-image">
                                      <img
                                        src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/pillartab_finance-copy.png?VersionId=cmCDnXYzcxXbuA3oQ3E0hDnaKkWha.jG"
                                        alt=" background image" />
                                    </div>
                                    <div class="accordion-tab-content">
                                      ...
                                      <p>Be intentional with both your saving and spending to make the most of what you
                                        are given, gaining financial peace of mind to support yourself and those you
                                        love.</p>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item"
                                  data-q2-deep-link-id="health-832">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                                          <i class="fas fa-apple-alt" data-fa-transform="" data-fa-mask=""
                                            style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                        </div>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="panel-bg-image">
                                      <img
                                        src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/pillartab_healthandwellness-copy_0.png?VersionId=2J_v2T.OyNlz_K8PxDquFzQ_9EElnYBB"
                                        alt=" background image" />
                                    </div>
                                    <div class="accordion-tab-content">
                                      ...
                                      <p>Care for your physical, mental, and spiritual health in order to be at your
                                        best for yourself and others, living each day to its fullest.</p>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item"
                                  data-q2-deep-link-id="growth-833">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                                          <i class="fas fa-book-reader" data-fa-transform="" data-fa-mask=""
                                            style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                        </div>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="panel-bg-image">
                                      <img
                                        src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/pillartab_personalgrowth-copy.png?VersionId=6K1iOFBX6mf3WLtz7ebfy75e5EVl3EqG"
                                        alt=" background image" />
                                    </div>
                                    <div class="accordion-tab-content">
                                      ...
                                      <p>Never stop learning and growing so that you may realize your fullest potential,
                                        live your purpose, and achieve your greatest success.</p>
                            ...
                            <div class="button-container">
                              ...
                              <a href="spendlifewisely.php" class="button"
                                aria-label="Spend Life Wisely blog page">Spend Life Wisely</a>
                        ...
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                            <div class="cell small-12 medium-8">
                              ...
                              <div id="about-us-stakeholders">
                                <div class="statement">
                                  <div class="section-summary">
                                    <p>The <span class="blue">employees</span>, <span class="blue">customers</span>,
                                      <span class="blue">shareholders</span>, <span class="blue">communities</span>, and
                                      <span class="blue">partners</span> who contribute to our shared success.</p>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="cell small-12 medium-4">
                              ...
                              <div class="align-center media-image" id="stakeholder-tree">

                                <img
                                  src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/stakeholder-tree-image-solid-copy.png?VersionId=CRP4JSLUO1EhvU5mLhgtE.._1GGlM.pi"
                                  width="2250" height="2283" alt="blue stakeholder tree" loading="lazy"
                                  typeof="foaf:Image" class="img-fluid" />
                              </div>
                      ...
                      <div class="q2-section call-to-action-section secondary gutter-none">
                        <div class="q2-wrap">
                          <p>Read about our amazing 2021 in the annual report. </p>

                          <a href="https://bekofcu.com/annualreport" class="button">Annual Report</a>
