...
<head>
  ...
  <link rel="canonical" href="agriculture-loans.php" />
  ...
  <link rel="alternate" hreflang="en" href="agriculture-loans.php" />

  <title>Agriculture Loans³ | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-personal-borrow-consumer-loans-overview-agriculture-loans path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        ...
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/ag-loans-internal3.jpg?VersionId=rNn8sY7NuB9dj9A7LyTMrArlkjTPXoma); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">


              <h1> Agriculture Loans³</h1>
              <p>Beko Federal Credit Union (BEKOFCU) can make joint financing arrangements with Farm Service Agency to make 50/50, 50/45/5, and Guaranteed loans for the purchase of farm/ranch real estate.</p>

            </div>

            <div class="banner-button">
              <p>Reach out to our Agricultural Lending Professionals. </p>

              <a href="#ag-contacts" class="no-new-window button" aria-label="Contact us through our Agricultural Lending Professionals">Contact Us </a>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/personal/borrow/consumer-loans-overview/agriculture-loans" typeof="schema:WebPage">


                    <span property="schema:name" content="Agriculture Loans³" class="hidden"></span>
                    ...
                    <div>
                        ...
                        <div class="q2-wrap grid-container">
                          ...
                          <div id="loans">
                            <div class="section-summary">
                              <p>Operating a successful farm or ranch requires a financial partner who understands your business. Beko Federal Credit Union is that partner, with over 100 years of serving the farming and ranching industry.<br />
                                <br />
                                In addition to the personal attention and convenient products and services, you can expect seasoned advice, flexible terms, competitive rates and quick decision making on all loan requests. <strong>Let us tailor a loan for you!</strong>
                              </p>
                            </div>
                            ...
                            <div class="cell small-12 medium-6 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/cards_ag-loans-2.png?VersionId=LVu7NnW25u2L83zJZkMBh_8SH9Xm6GjI" width="540" height="190" alt="Man standing in a field with two trackers behind him" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <h2>AGRICULTURE LOANS<sup>3</sup></h2>

                              <div id="loans">
                                <ul>
                                  <li>Crop and Livestock Loans&nbsp;</li>
                                  <li>Equipment Loans&nbsp;</li>
                                  <li>Operating Loans&nbsp;</li>
                                </ul>
                              </div>



                              <a href="#ag-contacts" class="button" aria-label="START HERE and contact one of our Agricultural Lending Professionals">START HERE</a>
                            ...
                            <div class="cell small-12 medium-6 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/cards_real-estate-financing-copy.png?VersionId=eyON1ogEvZ50H4_oOe0n_pFVJ8V6tUvp" width="540" height="190" alt="Imaginary house in the middle of a field" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <h2>REAL ESTATE FINANCING<sup>3</sup></h2>

                              <div id="loans">
                                <ul>
                                  <li>Purchase and Development Loans&nbsp;</li>
                                  <li>Direct loan origination &amp; service of Farmer Mac Program — long-term fixed or adjustable rates&nbsp;</li>
                                  <li>Refinancing&nbsp;</li>
                                  <li>Ag-Equity Line of Credit&nbsp;</li>
                                  <li>Ag-Related Facility Loans&nbsp;</li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/cards_personal-and-business-checking-accounts-copy.png?VersionId=mxkS0cDw7ErABYcR9EwoDeKUJjTXr1Tx" width="540" height="190" alt="Woman with cowboy hat smiling" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <h2>PERSONAL & BUSINESS CHECKING ACCOUNTS</h2>

                              <div id="loans">
                                <ul>
                                  <li>Instant Issue Debit Cards</li>
                                  <li>Online &amp; Mobile banking products &amp; services<sup>1</sup></li>
                                  <li>Online Banking Statements<sup>2</sup></li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/cards_insurance-farm-and-ranch-copy.png?VersionId=sYHB9nuO6X0akvgGFEwukWp9600_GN8H" width="540" height="190" alt="House on a big lot of land" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <h2>INSURANCE* FARM & RANCH</h2>

                              <div id="loans">
                                <ul>
                                  <li>Home &amp; Auto</li>
                                  <li>Wealth Management Retirement Plan</li>
                                </ul>
                              </div>
                      ...
                      <div class="q2-section general-section gutter-top ">
                        <div class="q2-wrap grid-container">
                          ...
                          <div id="loans">
                            <div id="ag-contacts">
                              <h2>Agricultural Lending Professionals</h2>
                            </div>
                            &nbsp;

                            <h3 class="orange"><u>Oklahoma</u></h3>
                          </div>
                      ...
                      <div class="q2-section grid-section columns gutter-bottom">
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-x grid-margin-y">

                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>Ada & Surrounding Areas</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span> Drew Adams</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (580) 559-8149</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:drew.adams@firstunitedbank.com" title="drew.adams@firstunitedbank.com">drew.adams@firstunitedbank.com</a></li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>Bokchito & Surrounding Areas</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span> Justin Behrens</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (580) 920-4909</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:jbehrens@firstunitedbank.com" title="jbehrens@firstunitedbank.com">jbehrens@firstunitedbank.com</a></li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>Colbert & Surrounding Areas</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span> Shane Patterson</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (580) 634-6471</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:spatterson@firstunitedbank.com" title="spatterson@firstunitedbank.com">spatterson@firstunitedbank.com</a></li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>Durant & Surrounding Areas</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span>
                                    Daylin Hash
                                  </li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span>
                                    (580) 634-6202
                                  </li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span>
                                    <a href="mailto:daylin.hash@firstunitedbank.com" title="daylin.hash@firstunitedbank.com">daylin.hash@firstunitedbank.com</a>
                                  </li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>Holdenville & Surrounding Areas</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span> Joe Hayden</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (405) 712-6201</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:joe.hayden@firstunitedbank.com" title="joe.hayden@firstunitedbank.com">joe.hayden@firstunitedbank.com</a></li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              ...
                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  ...
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span>
                                    <a href="mailto:jworthy@firstunitedbank.com" title="jworthy@firstunitedbank.com">jworthy@firstunitedbank.com</a>
                                  </li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>Pauls Valley, SW Oklahoma</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span> J.D. Bostic</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (405) 444-6106</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:jimmie@bostic@firstunitedbank.com" title="jimmie@bostic@firstunitedbank.com">jimmie.bostic@firstunitedbank.com</a></li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>Purcell & Surrounding Areas</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span> Jason Bean</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (405) 442-6014</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:jason.bean@firstunitedbank.com" title="jason.bean@firstunitedbank.com">jason.bean@firstunitedbank.com</a></li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>Seminole & Surrounding Areas</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span>Billy Norton</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (405) 716-6152</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:jason.bean@firstunitedbank.com" title="jason.bean@firstunitedbank.com">william.norton@firstunitedbank.com</a></li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>Shawnee & Surrounding Area</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span> Adam Hamilton</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (405) 481-8406</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:adam.hamilton@firstunitedbank.com" title="adam.hamilton@firstunitedbank.com">adam.hamilton@firstunitedbank.com</a></li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>Wewoka & Surrounding Areas</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span> Angie Johnson</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (405) 337-6101</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:majohnson@firstunitedbank.com" title="majohnson@firstunitedbank.com">majohnson@firstunitedbank.com</a></li>
                                </ul>
                              </div>
                      ...
                      <div class="q2-section grid-section columns gutter-bottom">
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>Austin & Surrounding Areas</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span> Luis Argueta</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (512) 263-6114</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:william.noron@firstunitedbank.com" title="william.noron@firstunitedbank.com">luis.argueta@firstunitedbank.com</a></li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              ...
                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li "><i class="fas fa-user fa-lg">&nbsp;</i></span> Beth Byer</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (512) 263-6102</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:bmccarley@firstunitedbank.com" title="bmccarley@firstunitedbank.com">beth.byer@firstunitedbank.com</a></li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>Bulverde & Surrounding Areas</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span> Raul Guerra</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (210) 619-2697</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:william.noron@firstunitedbank.com" title="william.noron@firstunitedbank.com">raul.guerra@firstunitedbank.com</a></li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>Fredricksburg & Surrounding Areas</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span> Taylor Ward</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (830) 990-7772</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:william.noron@firstunitedbank.com" title="william.noron@firstunitedbank.com">taylor.ward@firstunitedbank.com</a></li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>Marble Falls & Surrounding Areas</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span> Taylor Smith</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (830) 798-5262</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:william.noron@firstunitedbank.com" title="william.noron@firstunitedbank.com">taylor.smith@firstunitedbank.com</a></li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>North Texas & Surrounding Areas</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span> Bruce McCarley</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (940) 783-9312</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:william.noron@firstunitedbank.com" title="william.noron@firstunitedbank.com">bmccarley@firstunitedbank.com</a></li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>Seguin & Surrounding Areas</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span> Mark Cerda</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (830) 401-5198</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:william.noron@firstunitedbank.com" title="william.noron@firstunitedbank.com">mark.cerda@firstunitedbank.com</a></li>
                                </ul>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <h2>Temple & Surrounding Areas</h2>

                              <div id="loans">
                                <ul class="fa-ul custom-icon-padding">
                                  <li><span class="fa-li"><i class="fas fa-user fa-lg">&nbsp;</i></span> Daniel Jeanes</li>
                                  <li><span class="fa-li"><i class="fas fa-phone fa-lg">&nbsp;</i></span> (254) 770-5010</li>
                                  <li><span class="fa-li"><i class="fas fa-envelope fa-lg">&nbsp;</i></span> <a href="mailto:william.noron@firstunitedbank.com" title="william.noron@firstunitedbank.com">daniel.jeanes@firstunitedbank.com</a></li>
                                </ul>
                              </div>
