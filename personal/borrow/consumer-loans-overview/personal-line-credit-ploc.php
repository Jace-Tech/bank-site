...
<head>
  ...
  <link rel="canonical" href="personal-line-credit-ploc.php" />
  ...
  <link rel="alternate" hreflang="en" href="personal-line-credit-ploc.php" />

  <title>Personal Line of Credit (PLOC) | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-personal-borrow-consumer-loans-overview-personal-line-credit-ploc path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        ...
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/banner_ploc-.png?VersionId=4qoX_ksQW6Ut0H.rt.IlN2t9QedYD2HW); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">


              <h1> Personal Line of Credit (PLOC)</h1>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/personal/borrow/consumer-loans-overview/personal-line-credit-ploc" typeof="schema:WebPage">


                    <span property="schema:name" content="Personal Line of Credit (PLOC)" class="hidden"></span>
                    ...
                    <div>
                      ...
                      <div class="q2-section general-section gutter-top ">
                        <div class="q2-wrap grid-container">
                          ...
                          <h2>What is a Personal Line of Credit<sup>1,2</sup>?</h2>

                          <div class="section-summary"> 
                            <p class="large14rem">Similar to a credit card, a personal line of credit (PLOC) let's you borrow money against your approved credit limit. A personal line of credit is a great option if you need to borrow money regularly usually for large expenses like home improvement, vacations, or medical bills. Unlike a credit card a personal line of credit typically offers a larger borrowing limit and at a better rate.</p>

                            <p>More information and benefits of a personal line of credit can be found below. If you have questions Beko Federal Credit Union is here to help guide you with your financial needs. Find your <a aria-label="Community Bank Locations" data-entity-substitution="canonical" data-entity-type="node" data-entity-uuid="2a975d0a-12a6-49af-9f74-78cc0ea22229" href="../../../locations.php" rel="noopener" target="_blank" title="Community Banking Locations">local community bank here</a> or <a aria-label="PLOC Application" href="https://www.originatewebcenter.com/uopen/originate/welcome.do?auth=4f391399e3d72622" rel="nofollow noopener" target="_blank" title="PLOC Application">start an application online here</a>.</p>
                          </div>
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              ...
                              <ul class="fa-ul" style="margin: 0">
                                <li><span class="fa-li"><i class="far fa-hand-holding-usd fa-3x blue">&nbsp;</i></span>
                                  <div class="large14rem dark-blue ploc-benefits"><strong>Take advances as needed during the draw period</strong></div>
                                </li>
                              </ul>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              ...
                              <ul class="fa-ul" style="margin: 0">
                                <li><span class="fa-li"><i class="far fa-money-check fa-3x blue">&nbsp;</i></span>
                                  <div class="dark-blue large14rem ploc-benefits"><strong>Only pay interest on the amount you've drawn</strong></div>
                                </li>
                              </ul>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              ...
                              <ul class="fa-ul" style="margin: 0">
                                <li><span class="fa-li"><i class="far fa-sack-dollar fa-3x blue">&nbsp;</i></span>
                                  <div class="dark-blue large14rem ploc-benefits"><strong>Available balance available again once paid down</strong></div>
                                </li>
                              </ul>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              ...
                              <ul class="fa-ul" style="margin: 0">
                                <li><span class="fa-li"><i class="far fa-percent fa-3x blue">&nbsp;</i></span>
                                  <div class="dark-blue large14rem ploc-benefits"><strong>Variable Interest Rate</strong></div>
                                </li>
                              </ul>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              ...
                              <ul class="fa-ul" style="margin: 0">
                                <li><span class="fa-li"><i class="far fa-car-side fa-3x blue">&nbsp;</i></span>
                                  <div class="dark-blue large14rem ploc-benefits"><strong>No collateral required</strong></div>
                                </li>
                              </ul>
                      ...
                      <div class="q2-section call-to-action-section secondary gutter-none">
                        <div class="q2-wrap">
                          <p>Interested in getting a Personal Life of Credit?</p>

                          <a href="https://www.originatewebcenter.com/uopen/originate/welcome.do?auth=4f391399e3d72622" class="nofollow button" aria-label="Start here">Start Here</a>
                      ...
                      <div class="q2-section grid-section columns gutter-both">
                        <div class="q2-wrap grid-container">
                          <div class="section-title">
                            <h2>You can use a PLOC for a variety of things.</h2>
                          </div>
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-6 large-4 column">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/column_homeimprovement.png?VersionId=KPIlXY.gqsZOJAU.8gvGX82nV_xPN3rc" width="270" height="229" alt="Kitchen home improvement" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                            ...
                            <div class="cell small-12 medium-6 large-4 column">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/column_payoffdebt.png?VersionId=uAhpZJdutBdHXxzNe4yc4voIkUHSyYZ5" width="270" height="229" alt="Woman looking at her note happy" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                            ...
                            <div class="cell small-12 medium-6 large-4 column">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/column_unexpectedexpenses.png?VersionId=_35xQk9_m5b6nqDF3_9DtJW4HIPKECCZ" width="270" height="229" alt="Man looking at his computer in an unhappy way" loading="lazy" typeof="foaf:Image" class="img-fluid" />
