<footer class="light">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <h3>Beko Federal Credit Union (BEKOFCU)</h3>
                ...
                <div class="col-lg-4">
                    <ul class="text-list text-list-line">
                        ...
                        <li><b>Email</b><hr /><p>info@bekofcu.com.com</p></li>
        ...
        <div class="footer-bar">
            <div class="container">
                <span>© Beko Federal Credit Union (BEKOFCU) <?= date('Y'); ?>.</span> -  <a href="privacy">Privacy policy</a>
