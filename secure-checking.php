...
<head>
  ...
  <link rel="canonical" href="secure-checking.php" />
  ...
  <link rel="alternate" hreflang="en" href="secure-checking.php" />

  <title>Secure Checking | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-secure-checking path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        <?php include("./nav.php"); ?>
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-03/securechecking-banner-internal.jpg?VersionId=SM2lX687cdq2UUEtxmq.ZuvBf2Q3Tnde); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">


              <h1> Secure Checking</h1>
              <p>Meet the checking account with built-in identity and cell phone protection for the entire family. <sup>1,2,5</sup></p>

            </div>

            <div class="banner-button">
              <p>Open an account in less than 5 minutes. </p>

              <a href="#odao" class="odao secure1 tabindex-button button" aria-label="Start here for opening an account">START HERE</a>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/secure-checking" typeof="schema:WebPage">


                    <span property="schema:name" content="Secure Checking" class="hidden"></span>
                    ...
                    <div>
                      ...
                      <div class="q2-section general-section gutter-top grey">
                        <div class="q2-wrap grid-container">
                              ...
                              <div class="small-12 large-10 large-centered columns text-center">
                                ...
                                <div class="row">
                                  <div class="large-12 columns">
                                    ...
                                    <div class="row">
                                      <div class="small-10 small-centered columns"><button class="button radius large expand addProduct" data-product="secure_checking" id="userInputZipSend">Get Started</button>
                          ...
                          <div class="section-summary">
                            <p><br />
                              Peace of mind isn’t “nice to have” – it’s a must. At First United, we take all measures to help keep you protected along your financial journey, so you can stay focused on pursuing your passions.</p>
                          </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 callout">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/fullfeaturedchecking_card_362x500-copy.png?VersionId=vomy7BmF0X60IcNCHs4khbMWwoAeBQoG" width="362" height="500" alt="Hand using laptop with glasses on desk" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <h2>Full-Featured Checking<sup>†</sup></h2>

                              <p>Online banking and more — all the features you need to bank on your terms.</p>
                            ...
                            <div class="cell small-12 medium-6 large-4 callout">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/cellphoneprotection_card_362x500-copy.png?VersionId=p_ialjMic4iyDnb3Ejy0dR8OIQ6zHeNy" width="362" height="500" alt="Man in gray suit smiling while using smartphone and laptop" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <p>In the unfortunate event your cell phone is damaged or stolen, Cell Phone Protection may reimburse you the cost to repair or replace your device.<sup>2,5</sup></p>
                            ...
                            <div class="cell small-12 medium-6 large-4 callout">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/identityprotection_card_362x500-copy.png?VersionId=OcpteYs9UTQPMFuLjqdgYKoKiuYCOIGM" width="362" height="500" alt="Two hands holding a smartphone with the login page displaying" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <p>IDProtect® helps to safeguard you and your family from the rising threat of identity theft.<sup>1</sup></p>
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-5">
                              ...
                              <div class="button-container">
                                <span class="lead-text">Get protected today.</span>

                                <a href="#odao" class="odao secure2 tabindex-button button" aria-label="Start here for opening an account">START HERE</a>
                      ...
                      <div class="q2-section general-section gutter-top none">
                        <div class="q2-wrap grid-container">

                          <h2>The safe and easy way to protect what matters most.&nbsp;</h2>

                          <div class="section-summary">
                            <p><br />
                              You asked and we listened. Secure Checking with IDProtect® includes a comprehensive set of security features designed to give our customers the peace-of-mind they’ve been looking for.</p>
                          </div>
                      ...
                      <div class="q2-section grid-section none columns gutter-none mobile-center">
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-x grid-margin-y">
                              ...
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-laptop fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Online Banking<sup>6,7</sup></h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-home-heart fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Coverage for You and Your Entire Family<sup>1</sup></h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-mobile-alt fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Cell Phone Protection<sup>2,5</sup></h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-file-search fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>3-in-1 Credit Report<br /><sup style="color: red;"><em>registration/activation required</em></sup></h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-file-invoice-dollar fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-tachometer fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Credit Score<sup>3</sup><br /><sup style="color: red;"><em>registration/activation required</em></sup></h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-id-card fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Identity Monitoring<br /><sup style="color: red;"><em>registration/activation required</em></sup></h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-search-dollar fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Credit File Monitoring<sup>4</sup><br /><sup style="color: red;"><em>registration/activation required</em></sup></h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-file-pdf fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>e-Statements<sup>7</sup></h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-user-secret fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Identity Theft Expense Reimbursement Coverage<sup>2</sup></h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-user-shield fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Comprehensive Identity Theft Resolution Services</h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-credit-card fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Debit and Credit Card Registration<br /><sup style="color: red;"><em>registration/activation required</em></sup></h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-hand-holding-usd fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>No-Fee Foreign ATM Withdrawals<sup>9</sup></h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-house fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>$100 Off Mortgage Closing<sup>10</sup></h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-fingerprint fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fab fa-cc-visa fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Instant Issue Debit Card<sup>11</sup></h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              ...
                              <h2><a data-entity-substitution="canonical" data-entity-type="node" data-entity-uuid="66fa6c4c-d4c6-4256-84e1-6ef07f469a73" href="https://bekofcu.com/personalized-debit" title="YouFirst Personalized Debit Card">You<i>First</i> Personalized Debit Card</a><sup>8</sup></h2>
                            ...
                            <div class="cell small-12 medium-6 large-3 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-camera fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>
                      ...
                      <div class="q2-section call-to-action-section secondary gutter-none">
                        <div class="q2-wrap">
                          <p>Experience personal protection & peace of mind with IDProtect®</p>

                          <a href="https://www.idprotectme247.com/sec/" target="_blank" rel="nofollow" class="button" aria-label="Register Now by going to IDProtect page">Register Now</a>
                      ...
                      <div class="q2-section v-tabs-section grey gutter-both">
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-y">
                            ...
                            <div class="section-summary">
                              <p>Beko Federal Credit Union (BEKOFCU) is a financial services organization dedicated to helping you protect and make the most of your assets. But we’re a lot more than that. Banking and finance are what we do, not who we are. We invite you to discover what makes us unique. </p>
                            </div>
                            <div class="cell small-12 v-tabs">
                              <ul class="v-tabs vertical" data-responsive-accordion-tabs="accordion medium-tabs large-tabs" data-multi-expand="false" data-allow-all-closed="true">
                                ...
                                <li class=" accordion-item is-active" data-accordion-item="data-accordion-item" data-q2-deep-link-id="driven-by-values-365">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                                          <i class="fas fa-dove" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                        </div>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="panel-bg-image">
                                      <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/accoustic_drivebyvalues.jpg?VersionId=RpJooml.pZM4ExscB8Ptla9j.vT1YWTR" alt=" background image" />
                                    </div>
                                    <div class="accordion-tab-content">

                                      <p>Extending LOVE. Making IMPACT. These are the values that drive our organization forward everyday and fuel us in supporting our customers.</p>



                                      <a href="about-us.php" class="button" aria-label="View our Purpose &amp; Values on our About Us page">Our Purpose &amp; Values</a>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="holistic-approach-366">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                                          <i class="fas fa-spa" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                        </div>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="panel-bg-image">
                                      <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/accoustic_holisticapproach_0.jpg?VersionId=qxlKMM0CL33j4R6LTUnRrjHpSeT0usm8" alt=" background image" />
                                    </div>
                                    <div class="accordion-tab-content">

                                      <p>We exist to help you find your unique path to success. We believe success requires a balance of faith, financial well-being, health and personal growth.&nbsp;</p>



                                      <a href="spendlifewisely-overview.php" class="button" aria-label="Spend Life Wisely">Spend Life Wisely</a>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="culture-of-care-367">
                                  <a href="#" class="accordion-title">
                                    <span class="icon font-awesome">
                                      <div class="fontawesome-icons">
                                        <div class="fontawesome-icon">
                                          <i class="fas fa-hand-holding-heart" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                        </div>
                                  ...
                                  <div class="accordion-content" data-tab-content="data-tab-content">
                                    <div class="panel-bg-image">
                                      <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/accoustic_cultureofcare.jpg?VersionId=ZvZhCPcLR9EJpBVXUSgV9ZKF7SVZGwrH" alt=" background image" />
                                    </div>
                                    <div class="accordion-tab-content">

                                      <p>No two financial journeys are the same. We’ll meet you where you are, and help get you where you want to be. In business and in life.&nbsp;</p>



                                      <a href="contact-us.php" class="button" aria-label="Start a Relationship">Start a Relationship</a>
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                            <div class="cell small-12 medium-4">
                              ...
                              <div class="align-center media-image">
                                ...
                                <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/fubt-shield-large-spendnexchapterwisely-copy.png?VersionId=NcBcqJIFsPwB8E2hlU1SyDE0pTQG0x0n" width="320" height="364" alt="Happy senior couple " loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              </div>
                            ...
                            <div class="cell small-12 medium-8">
                              ...
                              <div id="slw-section">
                                ...
                                <p>The best way to assure financial security for you and your family is to build a solid plan now, so you can be worry-free and happy in your senior years.</p>
                              </div>
                              ...
                              <div class="button-container">
                                ...
                                <a href="https://bekofcu.com/spendlifewisely/getting-right-track-retirement" class="button" aria-label="FINANCIAL WELL BEING">FINANCIAL WELL BEING</a>
                      ...
                      <div class="q2-section general-section gutter-both grey">
                        <div class="q2-wrap grid-container">
                          ...
                          <div id="disclosure">
                            ...
                            <p>1&nbsp; Benefits are available to personal checking account owner(s), their joint account owners and their eligible family members subject to the terms and conditions for the applicable Benefits. Some Benefits require authentication, registration and/or activation. Benefits are not available to a “signer” on the account who is not an account owner or to businesses, clubs, trusts, organizations and/or churches and their members, or schools and their employees/students. Family Members include your spouse, persons qualifying as domestic partner, and children under 25 years of age and parent(s) of the account holder who are residents of the same household.</p>

                            <p>2&nbsp; Special Program Notes: The descriptions herein are summaries only and do not include all terms, conditions, and exclusions of the Benefits described. Please refer to the actual Guide to Benefit and/or insurance documents for complete details of coverage and exclusions. Coverage is offered through the company named in the Guide to Benefit or on the certificate of insurance. Insurance products are not insured by FDIC or any Federal Government Agency; not a deposit of or guaranteed by the bank or any bank affiliate.</p>

                            <p>3&nbsp; Credit Score is a VantageScore 3.0 based on single credit bureau data. Third parties may use a different VantageScore or a different type of credit score to assess your creditworthiness.</p>

                            <p>4&nbsp; Credit file monitoring may take several days to begin following activation.</p>

                            <p>5&nbsp; Cellular bill must be paid through Beko Federal Credit Union (BEKOFCU) Secure Checking Account. Does not include lost devices. For stolen devices, a police report is required. Coverage applies on up to four phones on cellular bill. Two claims per twelve month period, up to $400 per claim, $50 deductible.</p>

                            <p>6&nbsp; Message and data rates may apply. Such charges include those from your communications service provider.</p>

                            <p>7&nbsp; Activation/registration required.</p>

                            <p>8&nbsp; $9.95 per card.</p>

                            <p>9&nbsp; We'll waive 5 non-Beko Federal Credit Union (BEKOFCU) ATM cash withdrawal fees per month.</p>

                            <p>10&nbsp; Mortgage must be auto drafted from Beko Federal Credit Union (BEKOFCU) checking account. Applies to secondary market mortgage loan only.</p>

                            <p>11&nbsp; Additional replacement cards may be subject to a fee.</p>
                          </div>
