...
<head>
  ...
  <link rel="canonical" href="estate-planning.php" />
  ...
  <link rel="alternate" hreflang="en" href="estate-planning.php" />

  <title>Estate Planning | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-estate-planning path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        <?php include("./nav.php") ?>
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/estateplanning-internal.png?VersionId=.CSsB5.A2Mp3FX_ZBQKhKN.aQ6gfzEv_); background-position: 50% 50%;">
          <div class="grid-container">
            ...
            <div class="banner-button">
              ...
              <a href="contact-us.php" class="button" aria-label="Contact Us by going to our contacts page">Contact Us</a>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/estate-planning" typeof="schema:WebPage">


                    <span property="schema:name" content="Estate Planning" class="hidden"></span>
                      ...
                      <div class="q2-section general-section gutter-both ">
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="section-summary">
                            <p>The first step in estate planning is building your estate. Through careful planning and management, Beko Federal Credit Union Investment Services can help you manage your wealth over the years. Then the emphasis begins to shift. As the years pass, you will want to develop a strategy in an effort to provide your loved ones with long-term financial security that lasts well beyond your lifetime.<br />
                              <br />
                              When deciding the future of your assets, Beko Federal Credit Union Investment Services are prepared to assist you in developing a comprehensive estate plan that is motivated by your goals and is adherent to your wishes. Aside from the goal to preserve your wealth and its smooth distribution when the time is appropriate, our professionals stay current on changing tax laws and legal requirements, continuously exploring ways to help manage the potential impact of estate and income taxes.<br />
                              <br />
                              Our estate planning services include overseeing your estate's investments as well as working with your legal adviser to administer your estate.<br />
                            </p>
                          </div>
