...
<head>
  ...
  <link rel="canonical" href="trust-services.php" />
  ...
  <link rel="alternate" hreflang="en" href="trust-services.php" />

  <title>Trust Services | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-trust-services path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        <?php include("./nav.php") ?>
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/trustservices-internal-1.png?VersionId=L77hJInV26ifDs8ZYSRLci74UABuYl9D); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">


              <h1> Trust Services</h1>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/trust-services" typeof="schema:WebPage">


                    <span property="schema:name" content="Trust Services" class="hidden"></span>
                    ...
                    <div>
                      ...
                      <div class="q2-section general-section gutter-top ">
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="section-summary">
                            <p>Trusts are not a one-size-fits all arrangement. They are very flexible and can be designed to accomplish a broad range of estate planning and asset management goals. Our professionals at Beko Federal Credit Union have been helping design and implement trusts for many years. Specific needs call for special solutions - that is why our approach is geared to your personal goals and needs.<br />
                              <br />
                              <strong>A trust can help you meet goals as different as:</strong>
                            </p>
                          </div>
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                              ...
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-hand-holding-medical fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Supporting an elderly relative</h2>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-donate fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Making large charitable gifts</h2>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-notes-medical fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Managing your assets if you become incapacitated</h2>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fas fa-hands-helping fa-lg" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Creating future security for disabled loved ones</h2>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              ...
                              <h2>Providing long-term asset management for your family after your death</h2>
                            ...
                            <div class="cell small-12 medium-6 large-4 column no-image">
                              ...
                              <h2>Transferring assets to a younger generation under the terms you specify</h2>
                      ...
                      <div class="q2-section call-to-action-section secondary gutter-none">
                        <div class="q2-wrap">
                          <p>Are you a current Trust Customer with an account with us?</p>
                        ...
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="text-center" id="wealth-management"><img alt="LPL Financial logo" class="lpl-logo" src="https://q2-canvas-stg-files.s3.amazonaws.com/firstunitedbank/files/image/lpl_logo.png" />
                            <div class="security-message"><span>Securities offered through LPL Financial.</span><br />
                              <span>Member&nbsp;<a href="http://www.finra.org" target="_blank" title="Financial Industry Regulatory Authority" aria-label="Financial Industry Regulatory Authority" rel="nofollow">FINRA</a></span>/ <span><a href="http://www.sipc.org" target="_blank" title="Securities Investor Protection Corporation" aria-label="Securities Investor Protection Corporation" rel="nofollow">SIPC</a></span><br />
                              <span>Check the background of this firm on:</span><br />
                              <a aria-label="BrokerCheck by FINRA" title="BrokerCheck by FINRA" rel="nofollow" class="button" href="https://brokercheck.finra.org/firm/summary/6413" target="_blank">FINRA's BrokerCheck</a><br />
                          ...
                          <div id="disclosure">
                            <div class="row">
                              <div class="small-12 large-12 columns">
                                <p>
                                  Securities and advisory services offered through LPL Financial, a registered investment adviser. Member FINRA/SIPC. Insurance Products offered through LPL Financial or its licensed affiliates. The investment products sold through LPL Financial are not insured. Beko Federal Credit Union (BEKOFCU) deposits are not FDIC insured. These products are not obligations of Beko Federal Credit Union (BEKOFCU) and are not endorsed, recommended or guaranteed by Beko Federal Credit Union (BEKOFCU) or any government agency. The value of the investment may fluctuate, the return of the investment is not guaranteed, and loss of principal is possible.</br></br>

                                  The LPL Financial Registered Representatives associated with this site may only discuss and/or transact securities business with residents of the following states: AL, AZ, AR, CA, CO, FL, GA, IL, LA, KS, KY, MD, MI, MO, MT, NC, OH, OK, OR, PA, SD, TN, TX, UT, WA, WI, WV.</br></br>

                                  Beko Federal Credit Union (BEKOFCU) and the Wealth Management Group are not registered broker/dealers and are not affiliated with LPL Financial.</p>
                              </div>
                            </div>
                          </div>
