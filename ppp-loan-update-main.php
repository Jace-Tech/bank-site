...
<head>
  ...
  <link rel="canonical" href="ppp-loan-update-main.php" />
  ...
  <link rel="alternate" hreflang="en" href="ppp-loan-update-main.php" />

  <title>PPP Loan Update | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-ppp-loan-update-main path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <?php include("./header.php"); ?>
      <header>
        <?php include("./nav.php"); ?>
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/ppp-internal.png?VersionId=SS.Lw42RngApnhGJ8ayLCIXUnJPZVUlM); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">


              <h1> PPP Loan Update</h1>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/ppp-loan-update-main" typeof="schema:WebPage">


                    <span property="schema:name" content="PPP Loan Update" class="hidden"></span>
                    ...
                    <div>
                      ...
                      <div class="q2-section general-section gutter-top ">
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="section-summary">&nbsp;
                            <p>The Small Business Administration&nbsp;(SBA) is no longer accepting new applications for the Paycheck Protection Program (PPP). If you have already received a PPP loan, and have reached the end of your forgiveness period, you are encouraged to apply for forgiveness. If you have questions about the program or your loan, please contact a Beko Federal Credit Union (BEKOFCU)&nbsp;<a href="locations.php">location</a> near you.</p>
                          </div>
                            ...
                            <div class="cell small-12 medium-6 column">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/card_ppp-forgiveness.jpg?VersionId=BEW.RP5X25FxkydTbs1L0Tph1TqdVnPl" width="517" height="190" alt="PPP Loan Forgiveness Updates" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <a href="https://bekofcu.com/ppploan-forgiveness-information" class="button" aria-label="View PPP Loan Forgiveness Updates ">VIEW UPDATES</a>
                      ...
                      <div class="q2-section call-to-action-section secondary gutter-none">
                        <div class="q2-wrap">
                          <p>Find a nearby location for help with what you need. </p>
