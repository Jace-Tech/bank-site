...
<head>
  ...
  <link rel="canonical" href="retirement-planning.php" />
  ...
  <link rel="alternate" hreflang="en" href="retirement-planning.php" />

  <title>Retirement Planning | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-retirement-planning path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        <?php include("./nav.php"); ?>
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/retirementplanning-internal_0.png?VersionId=AuVWK4ZEmNsE93Zy6JC8GfBgoQTnsKUh); background-position: 50% 50%;">
          <div class="grid-container">
            <div cltrust-servicesass="internal-header">


              <h1> Retirement Planning</h1>
              <p>You have many choices for how you invest your savings - but with thousands of products and services, how do you know which ones will work the hardest to meet your needs?</p>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/retirement-planning" typeof="schema:WebPage">


                    <span property="schema:name" content="Retirement Planning" class="hidden"></span>
                    ...
                    <div>
                            ...
                            <div class="cell small-12 medium-6 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/card_401k-planning.jpg?VersionId=U6aVi2Gm5DcPRkaXkI2qy_AZtx33iUHa" width="517" height="190" alt="Senior couple sitting together" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <h2>401(k) Planning</h2>

                              <p>If you've changed jobs and left behind a 401(k) or other qualified plan, you could be neglecting one of your most important assets. We can help you manage and monitor your investments, creating a strategy that aligns your retirement savings with your overall financial goals.<br />
                                <br />
                                We can help you:
                              </p>

                              <ul>
                                <li>Learn the advantages and disadvantages of all available distribution options.</li>
                                <li><span>Learn the tax consequences of lump-sum distributions.</span></li>
                              </ul>
                            ...
                            <div class="cell small-12 medium-6 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/card_roth.jpg?VersionId=5J5joM4eo9N4e4SxD2Fdw9xL10LCrm7L" width="517" height="190" alt="Senior couple sitting together in their living room with a laptop and papers" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <p>Reducing the uncertainties associated with retirement always makes sense. A Roth IRA's tax advantages can plan an important role in navigating a future made more challenging by potentially higher tax rates and the need to work longer.<br />
                                <br />
                                Converting some or all of your IRA balances to a Roth IRA may yield potential benefits down the road. However, many factors should be considered, so let us help. We can discuss your situation and how a Roth IRA might be right for you.
                              </p>
                      ...
                      <div class="q2-section general-section gutter-top grey">
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="text-center" id="wealth-management"><img alt="LPL Financial logo" class="lpl-logo" src="https://q2-canvas-stg-files.s3.amazonaws.com/firstunitedbank/files/image/lpl_logo.png" />
                            <div class="security-message"><span>Securities offered through LPL Financial.</span><br />
                              <span>Member&nbsp;<a aria-label="Financial Industry Regulatory Authority" href="http://www.finra.org" rel="nofollow" target="_blank" title="Financial Industry Regulatory Authority">FINRA</a></span>/ <span><a aria-label="Securities Investor Protection Corporation" href="http://www.sipc.org" rel="nofollow" target="_blank" title="Securities Investor Protection Corporation">SIPC</a></span><br />
                              <span>Check the background of this firm on:</span><br />
                              <a aria-label="BrokerCheck by FINRA" class="button" href="https://brokercheck.finra.org/firm/summary/6413" rel="nofollow" target="_blank" title="BrokerCheck by FINRA">FINRA's BrokerCheck</a><br />
                              <img alt="Not FDIC Insured. No Bank Guarantee. May lose Value. Not a deposit. Not insured by any Federal Government Agency. Beko Federal Credit Union (BEKOFCU) &amp; Trust is not a registered broker/dealer and is not affiliated with LPL Financial." class="wm-footer" src="https://q2-canvas-stg-files.s3.amazonaws.com/firstunitedbank/files/image/wealth-management-footer.png" />
                            </div>
                          </div>
                          ...
                          <div id="disclosure">
                            <div class="row">
                              <div class="small-12 large-12 columns">
                                <p>Securities and advisory services offered through LPL Financial, a registered investment adviser. Member FINRA/SIPC. Insurance Products offered through LPL Financial or its licensed affiliates. The investment products sold through LPL Financial are not insured. Beko Federal Credit Union (BEKOFCU) deposits are not FDIC insured. These products are not obligations of Beko Federal Credit Union (BEKOFCU) and are not endorsed, recommended or guaranteed by Beko Federal Credit Union (BEKOFCU) or any government agency. The value of the investment may fluctuate, the return of the investment is not guaranteed, and loss of principal is possible.<br />
                                  <br />
                                  The LPL Financial Registered Representatives associated with this site may only discuss and/or transact securities business with residents of the following states: AL, AZ, AR, CA, CO, FL, GA, IL, LA, KS, KY, MD, MI, MO, MT, NC, OH, OK, OR, PA, SD, TN, TX, UT, WA, WI, WV.<br />
                                  <br />
                                  Beko Federal Credit Union (BEKOFCU) and the Wealth Management Group are not registered broker/dealers and are not affiliated with LPL Financial.
                                </p>
                              </div>
                            </div>
                          </div>
