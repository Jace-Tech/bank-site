...
<head>
  ...
  <link rel="canonical" href="business-checking-accounts.php" />
  ...
  <link rel="alternate" hreflang="en" href="business-checking-accounts.php" />

  <title>Business Checking Accounts | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-business-checking-accounts path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        <?php include("./nav.php") ?>
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/businesschecking-banner-internal.jpg?VersionId=j3050FtQTkPaUV.psZo..yb6ahCQfNOB); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">


              <h1> Business Checking Accounts </h1>
              <p>From growing businesses that need a little help managing cash flow to commercial businesses with high balances, Beko Federal Credit Union offers tailored options for every stage of the entrepreneurial journey. </p>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/business-checking-accounts" typeof="schema:WebPage">


                    <span property="schema:name" content="Business Checking Accounts " class="hidden"></span>
                    ...
                    <div>
                      ...
                      <div class="q2-section general-section gutter-top grey">
                        <div class="q2-wrap grid-container">
                          ...
                          <div id="cards-intro">
                            <h2>Manage day-to-day business with ease.</h2>

                            <div class="section-summary">
                              <p><br />
                                Orchestrating a business can be an around-the-clock job. Beko Federal Credit Union checking accounts work to help your business streamline cash flow and simplify accounting – so you can stay focused on the things you know and love most.</p>
                            </div>
                          </div>
                            ...
                            <div class="cell small-12 medium-6 large-4 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/card_ubf_360x171-1.png?VersionId=g36TNBHMJ3OcGk.VSKhWDPlyq7wSG46k" width="360" height="171" alt="Happy man with an apron working on his tablet." loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <h2>United Business Free </h2>

                              <p>Ideal for sole proprietors, DBAs, nonprofits, and some small businesses.</p>

                              <ul>
                                <li>First 300 transactions are waived<sup>1</sup></li>
                              ...
                              <a href="https://bekofcu.com/united-business-free" class="button" aria-label="Learn more by going to our United Business Free page">LEARN MORE</a>
                            ...
                            <div class="cell small-12 medium-6 large-4 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/card_u_360x171-1.png?VersionId=pMJFXDrVfVlRBcFFvGG93cceawni9G39" width="360" height="171" alt="Man talking on the phone" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <h2>United Business</h2>

                              <p>Meet the account designed with the small business in mind.</p>

                              <ul>
                                <li>First 450 transactions are waived<sup>2</sup></li>
                                <li>Online banking and bill pay</li>
                              </ul>



                              <a href="https://bekofcu.com/united-business" class="button" aria-label="Learn more by going to our United Business page">LEARN MORE</a>
                            ...
                            <div class="cell small-12 medium-6 large-4 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/card_uc_360x171-1_0.png?VersionId=0YOv5sejWryWVMxdFjBxnhedKKUTf4_l" width="360" height="171" alt="Two happy men with yellow construction hats working together. " loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <h2>United Commercial</h2>

                              <p>Designed for larger businesses with complex cash management needs.</p>

                              <ul>
                                <li>Best if writing 75+ checks per month</li>
                                <li>Earn credit on a percentage of the collected balance, and offset transaction charges</li>
                              ...
                              <a href="https://bekofcu.com/united-commercial" class="button" aria-label="Learn more by going to our United Commercial page">LEARN MORE</a>
                      ...
                      <div class="q2-section accordion-section grey gutter-bottom">
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-y">
                            ...
                            <div class="section-summary">
                              <p>Orchestrating a business can be an around-the-clock job. Beko Federal Credit Union checking accounts work to help your business streamline cash flow and simplify accounting – so you can stay focused on the things you know and love most. </p>
                            </div>
                            <div class="cell small-12 ">
                              <ul class="accordion" data-responsive-accordion-tabs="accordion" data-multi-expand="false" data-allow-all-closed="true">


                                <li class=" accordion-item is-active" data-accordion-item="data-accordion-item" data-q2-deep-link-id="united-business-free--497">
                                  <a href="#" class="accordion-title">
                                    <h3>
                                      United Business Free
                                    </h3>
                                  </a>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="-united-business-498">
                                  <a href="#" class="accordion-title">
                                    <h3>
                                      United Business
                                    </h3>
                                ...
                                <li class=" accordion-item" data-accordion-item="data-accordion-item" data-q2-deep-link-id="united-commercial-507">
                                  <a href="#" class="accordion-title">
                                    <h3>
                                      United Commercial
                                    </h3>
                      ...
                      <div class="q2-section general-section gutter-both ">
                        <div class="q2-wrap grid-container">
                          ...
                          <div aria-label="How to waive" class="reveal" data-reveal="" id="details-modal1">
                            <div class="row">
                              <div class="small-12 large-10 large-centered columns text-center"> 
                                <p>$9.95 monthly service charge that can be waived with $15,000 minimum daily balance in United Business checking or $50,000 loan balance.</p>
                          ...
                          <div id="compare-accounts">
                            ...
                            <div class="section-summary">
                              <p><br />
                                Whether you prefer paper checks or banking online, Beko Federal Credit Union has a checking account to fit the way you live.</p>
                            </div>

                            <table>
                              <caption class="sr-only">Compare Business Checking Accounts</caption>
                              <thead>
                                <tr>
                                  <td class="sticky row-desktop"> </td>
                                  <th scope="col">United Business Free
                                  ...
                                  <th scope="col">United Business
                                    <div class="start-button"><a aria-label="Start Here by going to our business deposit application page" class="button" data-entity-substitution="canonical" data-entity-type="node" data-entity-uuid="5f1adc51-1848-4cfd-af2d-71a4fe5eb581" href="https://bekofcu.com/business-deposit-application" title="Business Deposit Application page">Start <span class="hide-mobile">Here</span></a></div>

                                    <div class="start-icon"><a aria-label="Start Here by going to our business deposit application page" data-entity-substitution="canonical" data-entity-type="node" data-entity-uuid="5f1adc51-1848-4cfd-af2d-71a4fe5eb581" href="https://bekofcu.com/business-deposit-application" title="Business Deposit Application page"><i class="fa fa-external-link-alt fa-2x"> </i></a></div>
                                  </th>
                                  <th scope="col">United Commercial
                                    <div class="start-button"><a aria-label="Start Here by going to our business deposit application page" class="button" data-entity-substitution="canonical" data-entity-type="node" data-entity-uuid="5f1adc51-1848-4cfd-af2d-71a4fe5eb581" href="https://bekofcu.com/business-deposit-application" title="Business Deposit Application page">Start <span class="hide-mobile">Here</span></a></div>
                              ...
                              <tbody>
                                ...
                                <tr class="row-mobile">
                                  <th colspan="3" scope="row"><strong>Features</strong></th>
                                </tr>
                                <tr>
                                  <th class="row-desktop align-top"><strong>Features</strong></th>
                                  <td>
                                    <p><span>First 300 transactions free.<sup>1</sup></span></p>
                                  </td>
                                  <td>
                                    <p><span>First 450 transactions free.<sup>2</sup></span></p>
                                  </td>
                                  <td>
                                ...
                                <tr>
                                  <th class="row-desktop align-top"><strong>Service Charge</strong></th>
                                  <td class="align-top">
                                    <p><span>$0</span></p>
                                  </td>
                                  <td class="align-top">
                                ...
                                <tr>
                                  ...
                                  <td class="key-benefits align-top">
                                    <p>•   Visa® Debit Card<sup>3</sup><br />
                                      •   Online Banking<sup>4,5</sup><br />
                                      •   Mobile Banking<sup>4,5</sup><br />
                                      •   e-Statements<sup>4,5</sup></p>
                                  </td>
                                  <td class="key-benefits align-top">
                                    <p>•   Visa® Debit Card<sup>3</sup><br />
                                      •   Online Banking<sup>4,5</sup><br />
                            ...
                            <ul class="orbit-container">
                              ...
                              <li class="orbit-slide">
                                <figure class="orbit-figure">
                                  <div class="orbit-image" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/testimonial_businesschecking_0.png?VersionId=Y4VFOa87tSCUNhoBysOqCTGHdx8AMMoS); background-position: 50% 50%;"></div>
                                  <figcaption class="orbit-caption grid-container">
                                    <div class="grid-x">
                                      <div class="quote-container cell small-12">
                                        <h2 class="quote">"I just wanted to send you a note. I have been looking through all of our dashboards on the PPP program and you and your team are doing an outstanding job. The amount of loans already approved internally is fantastic. Keep up the good work and thank you!"</h2>
                                      </div>
                                      <div class="testimonial-name cell small-12">
                                        Tecumseh
                                        <div class="testimonial-sub">East Central Oklahoma</div>
                                      </div>
                                    </div>
                                  </figcaption>
                                </figure>
                      ...
                      <div class="q2-section general-section gutter-both ">
                        <div class="q2-wrap grid-container">
                          ...
                          <div id="disclosure">
                            <p>*&nbsp; Monthly Service Charge may vary and is determined by transaction volume, services utilized and earnings credit for balances maintained</p>

                            <p>1&nbsp; $0.35 per transaction if more than 300 debits, credits, and deposited items per month.</p>

                            <p>2&nbsp; $0.45 per per transaction if more than 450 debits, credits, and deposited items per month.</p>

                            <p>3&nbsp; Additional replacement cards may be subject to a fee.</p>
                            <p>4&nbsp; Message and data rates may apply. Such charges include those from your communications provider.</p>
                            <p>5&nbsp; Registration/Activation required.</p>
                          </div>
