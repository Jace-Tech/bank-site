...
<head>
  ...
  <link rel="canonical" href="employee-benefits.php" />
  ...
  <link rel="alternate" hreflang="en" href="employee-benefits.php" />

  <title>Employee Benefits | Beko Federal Credit Union (BEKOFCU)</title>
  ...
  <link rel="stylesheet" media="all" href="https://bekofcu.com/modules/contrib/webform/css/webform.composite.css?ro3e14" />
  <link rel="stylesheet" media="all" href="https://bekofcu.com/modules/contrib/webform/css/webform.element.options.css?ro3e14" />
...
<body class="path-insurance-business-insurance-employee-benefits path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        ...
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/2021-04/banner-internal-employeebenefits.jpg?VersionId=e.IKEeNVpIOLG3cnPwunCcyDoMbIgDXg); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">


              <h1> Employee Benefits</h1>
              <p>Complexity around compliance issues and yearly premium increases require professional advice provided by Unity Insurance Partners.</p>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/insurance/business-insurance/employee-benefits" typeof="schema:WebPage">


                    <span property="schema:name" content="Employee Benefits" class="hidden"></span>
                      ...
                      <div class="q2-section general-section gutter-top ">
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="section-summary">
                            <p>When you think about designing and purchasing employee benefits in today’s market, you are faced with rising costs, compliance issues and complexity. Our team will partner with you to design the most cost effective program and help you though the complexity of compliance and changing legislation. We will send you frequent updates and ideas to help you manage this process.</p>
                          </div>
                      ...
                      <div class="q2-section webform-section none  gutter-bottom">
                        <div class="global-width grid-x grid-margin-x grid-margin-y">
                          <div class="cell small-12  medium-6">
                            ...
                            <div class="q2-section grid-section cards gutter-none" id="insurance-service">
                              <div class="cell small-12 card no-image">
                                ...
                                <ul>
                                  <li>Group Medical, Dental &amp; Vision</li>
                                  <li>Group Life &amp; ADD</li>
                                  <li>Short &amp; Long-term Disability</li>
                                  <li>Voluntary Payroll Deduction Benefits</li>
                              ...
                              <div class="cell small-12 card no-image">
                                <h2>Employee Benefits Compliance Support.</h2>

                                <ul>
                                  <li><strong>Affordable Care Act</strong>&nbsp;- provide current IRS Legislative updates as changes occur.</li>
                                  <li><strong>Required IRS Notices</strong>&nbsp;- provide employers with custom designed IRS notices for employees.</li>
                                  <li><strong>F.S.A.</strong>&nbsp;- provide education regarding how to calculate annual contributions and what expenses are eligible expenses.</li>
                                  <li><strong>H.S.A.</strong>&nbsp;- provide assistance with annual calculations and determination of funding.</li>
                                </ul>
                              </div>
                            </div>
                          ...
                          <div class="webform-container cell small-12 medium-6">
                            ...
                            <form class="webform-submission-form webform-submission-add-form webform-submission-employee-benefits-form webform-submission-employee-benefits-add-form webform-submission-employee-benefits-paragraph-1506-form webform-submission-employee-benefits-paragraph-1506-add-form employee-benefits-wb js-webform-details-toggle webform-details-toggle antibot" data-drupal-selector="webform-submission-employee-benefits-paragraph-1506-add-form" data-action="/insurance/business-insurance/employee-benefits" action="https://bekofcu.com/antibot" method="post" id="webform-submission-employee-benefits-paragraph-1506-add-form" accept-charset="UTF-8">

                              <noscript>
                                <div class="antibot-no-js antibot-message antibot-message-warning">You must have JavaScript enabled to use this form.</div>
                              </noscript>
                              <section data-drupal-selector="edit-informationrequestform" id="edit-informationrequestform" class="js-form-item form-item js-form-wrapper form-wrapper webform-section">
                                <h3 class="webform-section-title">Information Request Form</h3>
                                <div class="webform-section-wrapper">

                                </div>
                              </section>
                              <fieldset data-drupal-selector="edit-user-info" id="edit-user-info" class="js-webform-type-fieldset webform-type-fieldset js-form-item form-item js-form-wrapper form-wrapper">
                                <legend>
                                  <span class="visually-hidden fieldset-legend">insurance_customer_profile</span>
                                </legend>
                              ...
                              <fieldset style="font-weight: 900; margin-top: 0.5rem;" data-drupal-selector="edit-number-of-employees" id="edit-number-of-employees" class="js-webform-type-fieldset webform-type-fieldset js-form-item form-item js-form-wrapper form-wrapper">
                                <legend>
                                  <span class="fieldset-legend">How Many Employees Do You Have?</span>
                                </legend>
                                <div class="fieldset-wrapper">
                                  <fieldset data-drupal-selector="edit-how-many-employees-do-you-have-" id="edit-how-many-employees-do-you-have---wrapper" class="radios--wrapper fieldgroup form-composite webform-composite-visible-title js-webform-type-radios webform-type-radios js-form-item form-item js-form-wrapper form-wrapper" role="radiogroup" aria-labelledby="edit-how-many-employees-do-you-have---wrapper-legend">
                                    <legend style="display:none" id="edit-how-many-employees-do-you-have---wrapper-legend">
                                      <span class="fieldset-legend"></span>
                                    </legend>
                                    <div class="fieldset-wrapper">
                                      <div id="edit-how-many-employees-do-you-have-" class="js-webform-radios webform-options-display-side-by-side">
                                        <div class="js-form-item form-item js-form-type-radio form-item-how-many-employees-do-you-have- js-form-item-how-many-employees-do-you-have-">
                                          <input data-drupal-selector="edit-how-many-employees-do-you-have-1" type="radio" id="edit-how-many-employees-do-you-have-1" name="how_many_employees_do_you_have_" value="1" class="form-radio" />

                                          <label for="edit-how-many-employees-do-you-have-1" class="option">1 - 10</label>
                                        </div>
                                        <div class="js-form-item form-item js-form-type-radio form-item-how-many-employees-do-you-have- js-form-item-how-many-employees-do-you-have-">
                                          <input data-drupal-selector="edit-how-many-employees-do-you-have-2" type="radio" id="edit-how-many-employees-do-you-have-2" name="how_many_employees_do_you_have_" value="2" class="form-radio" />

                                          <label for="edit-how-many-employees-do-you-have-2" class="option">11 - 50</label>
                                        </div>
                                        <div class="js-form-item form-item js-form-type-radio form-item-how-many-employees-do-you-have- js-form-item-how-many-employees-do-you-have-">
                                          <input data-drupal-selector="edit-how-many-employees-do-you-have-3" type="radio" id="edit-how-many-employees-do-you-have-3" name="how_many_employees_do_you_have_" value="3" class="form-radio" />

                                          <label for="edit-how-many-employees-do-you-have-3" class="option">51 - 200</label>
                                        </div>
                                        <div class="js-form-item form-item js-form-type-radio form-item-how-many-employees-do-you-have- js-form-item-how-many-employees-do-you-have-">
                                          <input data-drupal-selector="edit-how-many-employees-do-you-have-4" type="radio" id="edit-how-many-employees-do-you-have-4" name="how_many_employees_do_you_have_" value="4" class="form-radio" />

                                          <label for="edit-how-many-employees-do-you-have-4" class="option">201 - 500</label>
                                        </div>
                                        <div class="js-form-item form-item js-form-type-radio form-item-how-many-employees-do-you-have- js-form-item-how-many-employees-do-you-have-">
                                          <input data-drupal-selector="edit-how-many-employees-do-you-have-5" type="radio" id="edit-how-many-employees-do-you-have-5" name="how_many_employees_do_you_have_" value="5" class="form-radio" />

                                          <label for="edit-how-many-employees-do-you-have-5" class="option">501 - 1000</label>
                                        </div>
                                        <div class="js-form-item form-item js-form-type-radio form-item-how-many-employees-do-you-have- js-form-item-how-many-employees-do-you-have-">
                                          <input data-drupal-selector="edit-how-many-employees-do-you-have-6" type="radio" id="edit-how-many-employees-do-you-have-6" name="how_many_employees_do_you_have_" value="6" class="form-radio" />

                                          <label for="edit-how-many-employees-do-you-have-6" class="option">1001 - 5000</label>
                                        </div>
                                        <div class="js-form-item form-item js-form-type-radio form-item-how-many-employees-do-you-have- js-form-item-how-many-employees-do-you-have-">
                                          <input data-drupal-selector="edit-how-many-employees-do-you-have-7" type="radio" id="edit-how-many-employees-do-you-have-7" name="how_many_employees_do_you_have_" value="7" class="form-radio" />

                                          <label for="edit-how-many-employees-do-you-have-7" class="option">5001 - 10,000</label>
                                        </div>
                                        <div class="js-form-item form-item js-form-type-radio form-item-how-many-employees-do-you-have- js-form-item-how-many-employees-do-you-have-">
                                          <input data-drupal-selector="edit-how-many-employees-do-you-have-8" type="radio" id="edit-how-many-employees-do-you-have-8" name="how_many_employees_do_you_have_" value="8" class="form-radio" />

                                          <label for="edit-how-many-employees-do-you-have-8" class="option">10,000 - 25,000</label>
                                        </div>
                                        <div class="js-form-item form-item js-form-type-radio form-item-how-many-employees-do-you-have- js-form-item-how-many-employees-do-you-have-">
                                          <input data-drupal-selector="edit-how-many-employees-do-you-have-9" type="radio" id="edit-how-many-employees-do-you-have-9" name="how_many_employees_do_you_have_" value="9" class="form-radio" />

                                          <label for="edit-how-many-employees-do-you-have-9" class="option">25,000+</label>
                                        </div>
                                      </div>
                              ...
                              <fieldset style="font-weight: 900; margin-top: 0.5rem;" data-drupal-selector="edit-area-of-interest" id="edit-area-of-interest" class="js-webform-type-fieldset webform-type-fieldset js-form-item form-item js-form-wrapper form-wrapper">
                                ...
                                <div class="fieldset-wrapper">
                                  <div class="js-form-item form-item js-form-type-checkbox form-item--recreational-vehicle-insurance js-form-item--recreational-vehicle-insurance">
                                    ...
                                    <label for="edit-recreational-vehicle-insurance" class="option">Group 401k</label>
                                  </div>
                                  <div class="js-form-item form-item js-form-type-checkbox form-item-renters-insurance js-form-item-renters-insurance">
                                    ...
                                    <label for="edit-renters-insurance" class="option">Group Dental</label>
                                  </div>
                                  <div class="js-form-item form-item js-form-type-checkbox form-item-auto-insurance js-form-item-auto-insurance">
                                    ...
                                    <label for="edit-auto-insurance" class="option">Group Health</label>
                                  </div>
                                  <div class="js-form-item form-item js-form-type-checkbox form-item-homeowners-insurance js-form-item-homeowners-insurance">
                                    ...
                                    <label for="edit-homeowners-insurance" class="option">Group Life</label>
                                  </div>
                              ...
                              <input autocomplete="off" data-drupal-selector="form-3z5neppid4tobvlvvzgh4sygbwignsuos3norty834u" type="hidden" name="form_build_id" value="form-3z5nEppId4TOBVLvVzgH4sYGbWIgNsuos3NORtY834U" />
                              <input data-drupal-selector="edit-webform-submission-employee-benefits-paragraph-1506-add-form" type="hidden" name="form_id" value="webform_submission_employee_benefits_paragraph_1506_add_form" />
  ...
  <script src="https://bekofcu.com/modules/contrib/webform/js/webform.element.options.js?v=9.5.1"></script>
