...
<head>
  ...
  <link rel="canonical" href="homeowners-insurance.php" />
  ...
  <link rel="alternate" hreflang="en" href="homeowners-insurance.php" />

  <title>Homeowners Insurance | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-insurance-personal-insurance-homeowners-insurance path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <header>
        ...
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/home-insurance-internal.png?VersionId=XLCCHkf8G5LXqvMT4AasYlKgGKRIXez0); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">


              <h1> Homeowners Insurance</h1>
              <p>The biggest investment most people will ever make is in their home. That’s why it makes sense to protect the sizable financial investment you’ve made in your own home with a comprehensive homeowners plan.</p>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/insurance/personal-insurance/homeowners-insurance" typeof="schema:WebPage">


                    <span property="schema:name" content="Homeowners Insurance" class="hidden"></span>
                      ...
                      <div class="q2-section general-section gutter-top ">
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="section-summary">
                            <p>Your home purchase is an investment deserving the protection that only an experienced insurance professional can provide.</p>
                          </div>
                        ...
                        <div class="global-width grid-x grid-margin-x grid-margin-y">
                          <div class="cell small-12  medium-6">
                            ...
                            <div class="q2-section grid-section cards gutter-none" id="insurance-service">
                              <div class="cell small-12 card no-image">
                                <h2>Basic Protection You Need For:</h2>

                                <ul>
                                  <li>Your home</li>
                                  <li>Other buildings or structures on your property</li>
                                  <li>Your personal belongings - furniture, clothing, appliances, etc.</li>
                                  <li>Additional living expenses</li>
                                  <li>Your personal legal liability</li>
                                </ul>

                                <h2>Special features you can choose for additional security:</h2>

                                <ul>
                                  <li>Home Replacement Guarantee</li>
                                  <li>Replacement Cost on Contents</li>
                                  <li>Additional Coverage Form</li>
                                </ul>
                              </div>
                            </div>
                          ...
                          <div class="webform-container cell small-12 medium-6">
                            ...
                            <form class="webform-submission-form webform-submission-add-form webform-submission-insurance-sign-up-form-form webform-submission-insurance-sign-up-form-add-form webform-submission-insurance-sign-up-form-paragraph-1512-form webform-submission-insurance-sign-up-form-paragraph-1512-add-form general-insurance-wb js-webform-details-toggle webform-details-toggle antibot" data-drupal-selector="webform-submission-insurance-sign-up-form-paragraph-1512-add-form" data-action="/insurance/personal-insurance/homeowners-insurance" action="https://bekofcu.com/antibot" method="post" id="webform-submission-insurance-sign-up-form-paragraph-1512-add-form" accept-charset="UTF-8">
                              ...
                              <input autocomplete="off" data-drupal-selector="form-bw6tyaoz5xpfv6bpqiukxob3m8i2kdm4ddc4kvwdzu8" type="hidden" name="form_build_id" value="form-BW6tyAoz5XPFv6BPQIUKXob3M8i2kDM4ddC4KvWDZu8" />
                              <input data-drupal-selector="edit-webform-submission-insurance-sign-up-form-paragraph-1512-add-form" type="hidden" name="form_id" value="webform_submission_insurance_sign_up_form_paragraph_1512_add_form" />
