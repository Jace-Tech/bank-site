...
<head>
  ...
  <link rel="canonical" href="personal-insurance-products.php" />
  ...
  <link rel="alternate" hreflang="en" href="personal-insurance-products.php" />

  <title>Personal Insurance Products | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-insurance-personal-insurance-personal-insurance-products path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <?php include("../../nav2.php"); ?>
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/banner-internal-personalinsurance.png?VersionId=zSen2byStU.i19M8lIk7VYAG5gASK2SQ); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">


              <h1> Personal Insurance Products</h1>
              <p>We work with preferred companies to provide all of your personal insurance needs including Home, Auto and Specialty products.</p>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/insurance/personal-insurance/personal-insurance-products" typeof="schema:WebPage">


                    <span property="schema:name" content="Personal Insurance Products" class="hidden"></span>
                      ...
                      <div class="q2-section general-section gutter-top ">
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="section-summary">
                            <p>When you purchase insurance for yourself and your family, you are faced with many decisions: types of coverages, limits, deductibles, differences in policy forms, differences in insurance companies. When you partner with us, we help you design the program that is right for you.</p>
                          </div>
                        ...
                        <div class="global-width grid-x grid-margin-x grid-margin-y">
                          <div class="cell small-12  medium-6">
                            ...
                            <div class="q2-section grid-section cards gutter-none" id="insurance-service">
                              <div class="cell small-12 card no-image">
                                <h2>Beyond placing coverage for your home and autos, we will assist you with:</h2>

                                <ul>
                                  <li>Farm and ranch</li>
                                  <li>Personal umbrella</li>
                                  <li>Jewelry and fine arts</li>
                                  <li>Identity theft</li>
                                  <li>Rental property</li>
                                  <li>Boats and recreational vehicles</li>
                                </ul>
                              </div>
                              &nbsp;

                              <div class="cell small-12 card no-image">
                                <h2>Our longstanding relationships with our insurance company partners enables us to secure the best pricing and terms for you.</h2>

                                <p><img alt="Progressive logo" src="https://q2-canvas-stg-files.s3.amazonaws.com/firstunitedbank/files/2021-03/column-progressive.jpg?tHNRycCTi.YO7YVywNwPwQoaHAbASenk" typeof="foaf:Image" /> <img alt="Safeco Insurance A Liberty Mutual Company logo" src="https://q2-canvas-stg-files.s3.amazonaws.com/firstunitedbank/files/2021-03/column-safeco.jpg?qVntwX4mO4yf6VWEbYY52EGD95xIN00Q" typeof="foaf:Image" /> <img alt="Mercury Insurance logo" src="https://q2-canvas-stg-files.s3.amazonaws.com/firstunitedbank/files/2021-03/column-mercuryinsurance.jpg?oXxJq.vHMByaIWl0OUVSEeMdX4moOgVV" typeof="foaf:Image" /> <img alt="The Hartford logo" src="https://q2-canvas-stg-files.s3.amazonaws.com/firstunitedbank/files/2021-03/column-thehartford.jpg?QHHVoDw_4DHZ6CZZ0Xz3husoozZZfxf6" typeof="foaf:Image" /> <img alt="Travelers logo" src="https://q2-canvas-stg-files.s3.amazonaws.com/firstunitedbank/files/2021-03/column-travelers.jpg?_FOgzMZ5nZQSwEggMjxbc6RADaD04yoI" typeof="foaf:Image" /> <img alt="Allstate You're in good hands logo" src="https://q2-canvas-stg-files.s3.amazonaws.com/firstunitedbank/files/2021-03/column-allstate.jpg?1pbJqigI7VTa2gCq4Q75gpnahEEPLgzH" typeof="foaf:Image" /></p>
                              </div>
                            </div>
                          ...
                          <div class="webform-container cell small-12 medium-6">
                            ...
                            <form class="webform-submission-form webform-submission-add-form webform-submission-insurance-sign-up-form-form webform-submission-insurance-sign-up-form-add-form webform-submission-insurance-sign-up-form-paragraph-1504-form webform-submission-insurance-sign-up-form-paragraph-1504-add-form general-insurance-wb js-webform-details-toggle webform-details-toggle antibot" data-drupal-selector="webform-submission-insurance-sign-up-form-paragraph-1504-add-form" data-action="/insurance/personal-insurance/personal-insurance-products" action="https://bekofcu.com/antibot" method="post" id="webform-submission-insurance-sign-up-form-paragraph-1504-add-form" accept-charset="UTF-8">
                              ...
                              <input autocomplete="off" data-drupal-selector="form-k3kl1gnucqx39psb-0wbe67hw4jrmop2svoljz0frsk" type="hidden" name="form_build_id" value="form-K3kL1GnUcQx39psb-0wBe67hw4JrmOP2svOLJZ0FRsk" />
                              <input data-drupal-selector="edit-webform-submission-insurance-sign-up-form-paragraph-1504-add-form" type="hidden" name="form_id" value="webform_submission_insurance_sign_up_form_paragraph_1504_add_form" />
