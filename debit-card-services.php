...
<head>
  ...
  <link rel="canonical" href="debit-card-services.php" />
  ...
  <link rel="alternate" hreflang="en" href="debit-card-services.php" />

  <title>Debit Card Services | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-debit-card-services path-node page-node-type-page page-published">
  ...
  <div class="dialog-off-canvas-main-canvas" data-off-canvas-main-canvas>
    ...
    <?php include("./header.php"); ?>
      <header>
        <?php include("./nav.php"); ?>
        <div class="internal-page-banner banner-img" style="background-image: url(https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/debit-card-services-internal.png?VersionId=se0xAMuP9HAfVCWpbQNEZkFPQuzvuLM7); background-position: 50% 50%;">
          <div class="grid-container">
            <div class="internal-header">


              <h1> Debit Card Services</h1>
              <p>Use your debit card to shop local, buy online and pay monthly bills. You don’t even need a checkbook or ATM. All you need is one little card that’s fast, easy and safe - and can be used with ApplePay®.</p>

            </div>

            <div class="banner-button">
              <p>Need to report a lost or stolen debit card? </p>

              <a href="reporting-a-lost-card.php" class="button" aria-label="Start here by going to our checking overview page">START HERE</a>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/debit-card-services" typeof="schema:WebPage">


                    <span property="schema:name" content="Debit Card Services" class="hidden"></span>
                      ...
                      <div class="q2-section general-section gutter-top grey">
                        <div class="q2-wrap grid-container">
                          ...
                          <div class="section-summary">
                            <p>Beko Federal Credit Union (BEKOFCU) customers have Debit Card options that are convenient, fun and immediately available. Click on one of the links below to get started with your order, or stop-by one of our locations to pick up a new card.</p>
                          </div>
                            ...
                            <div class="cell small-12 medium-6 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/card-youfirst-copy_0.png?VersionId=q.ZcN7YQpTg7IbEftaGDZMDHcbpd7Hh0" width="890" height="550" alt="Woman holding a dog design debit card" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <h2>Personalized You<i>First</i> Debit Cards </h2>

                              <p>Personalize your banking by designing your very own debit card!</p>



                              <a href="https://bekofcu.com/personalized-debit" class="button" aria-label="Learn more by going to our YouFirst Personalized Debit Cards page">LEARN MORE</a>
                            ...
                            <div class="cell small-12 medium-6 card">
                              <div class="icon image">
                                <div class="media-image">
                                  ...
                                  <img src="https://trabian-canvas-prd-files.s3.amazonaws.com/firstunitedbank-com/files/image/card-instantissue-copy_0.png?VersionId=dU_eNwQ3yIwSxvCZvZh6SFg4bVT68apD" width="890" height="550" alt="Three hands holding up a Beko Federal Credit Union (BEKOFCU) debit card" loading="lazy" typeof="foaf:Image" class="img-fluid" />
                              ...
                              <h2>Instant Issue VISA® Debit Cards</h2>

                              <p>There's no need to wait for your new or replacement debit card to arrive in the mail!</p>



                              <a href="https://bekofcu.com/instant-issue-debit-card" class="button" aria-label="Learn more by going to our Instant Issue Debit Card page">LEARN MORE</a>
