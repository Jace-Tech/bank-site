...
<head>
  ...
  <link rel="canonical" href="additional-services.html" />
  ...
  <link rel="alternate" hreflang="en" href="additional-services.html" />

  <title>Additional Services | Beko Federal Credit Union (BEKOFCU)</title>
...
<body class="path-additional-services path-node page-node-type-page page-published">
        ...
        <div class="internal-page-banner">
          <div class="grid-container">
            ...
            <div class="banner-button">
              <p>Find a community bank near you.</p>

              <a href="locations.php" class="button" aria-label="Visit us by going to our locations page. ">Visit Us </a>
            ...
            <section class="cell small-12">
              ...
              <div>
                <div id="block-firstunitedbank-content">
                  ...
                  <article role="article" about="/additional-services" typeof="schema:WebPage">


                    <span property="schema:name" content="Additional Services" class="hidden"></span>
                    ...
                    <div>
                      ...
                      <div class="q2-section grid-section grey cards gutter-both">
                        <div class="q2-wrap grid-container">
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-6 card no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fal fa-archive fa-2x" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>
                              ...
                              <p>Safeguard your valuables and important documents 24 hours a day from accidents that could occur at home with a Safety Deposit Box from First United. We combine security with ease of access to give you peace of mind. To reserve a Safety&nbsp;Deposit Box, just visit your nearest Beko Federal Credit Union location.</p>



                              <a href="locations.php" class="button" aria-label="Find a location near you on our locations page">FIND A LOCATION</a>
                            ...
                            <div class="cell small-12 medium-6 card no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fal fa-clock fa-2x" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>24-Hour Depository</h2>

                              <p>Drop off your deposit or make a loan payment any time at the depository located at your nearest Beko Federal Credit Union location. Deposits and loans are credited on the next regularly scheduled business day.</p>
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-6 card no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fal fa-arrows-alt-h fa-2x" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>

                                </div>

                              </div>
                              <h2>Automatic Fund Transfer</h2>

                              <p>Our Automated Fund Transfer (AFT) service allows customers that have accounts within Beko Federal Credit Union to transfer in and out of their existing accounts at our bank. Loan payments as well as distributions among your various accounts can be set at a frequency you choose through this convenient, free service. Have accounts out of the bank? You can read more about our Bank to Bank transfer service available by logging in to Online Banking.</p>
                            ...
                            <div class="cell small-12 medium-6 card no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fal fa-file-signature fa-2x" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>
                              ...
                              <p>A Notary Public is available at every Beko Federal Credit Union location during normal banking hours.</p>

                              <p>A licensed notary will certify and confirm a signer's identity for legal documents, guardianship, depositions and other certified documents free of charge to Beko Federal Credit Union customers.</p>
                          ...
                          <div class="grid-x grid-margin-x grid-margin-y">
                            ...
                            <div class="cell small-12 medium-6 card no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fal fa-exchange fa-2x" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>
                              ...
                              <p>Move money in a flash for a nominal fee. Transfers can be completed at any Beko Federal Credit Union location, or initiated through Online Banking.</p>

                              <p>When you need to transfer funds immediately, we offer wire transfer services to domestic and international banks. Speed up the wire process by filling out the associated wire form prior to coming into the bank by using either of the printer friendly versions of our wire forms provided.</p>

                              <p>Please call <strong>(800)924-4427x1373</strong> for information regarding wiring money to Beko Federal Credit Union (BEKOFCU).</p>

                              <p class="small-text"><i>*Must use Online Treasury Management services for online wire transfer.</i></p>

                              <p>&nbsp;</p>

                              <div class="align-content-bottom"><span><a aria-label="Domestic Wire Form" class="button" href="https://q2-canvas-stg-files.s3.amazonaws.com/firstunitedbank-com/files/document/wires_required_request_fields_domesticcustomer.pdf?exnuDOYtgkh3AxvXac3aD7bR4Kw1yD_i=" rel="nofollow" target="_blank" title="Domestic Wire Form">Domestic Wire Form</a></span><br />
                                <br />
                                <span><a aria-label="International Wire Form" class="button" href="https://q2-canvas-stg-files.s3.amazonaws.com/firstunitedbank-com/files/document/wires_required_request_fields_foreigncustomer.pdf?vzOXSTgarkvWrbinpwAN0uhluaMlh7Uj=" rel="nofollow" target="_blank" title="International Wire Form">International Wire Form</a></span>
                              </div>
                            ...
                            <div class="cell small-12 medium-6 card no-image">
                              <div class="icon font-awesome">
                                <div class="fontawesome-icons">
                                  <div class="fontawesome-icon">
                                    <i class="fal fa-hand-holding-usd fa-2x" data-fa-transform="" data-fa-mask="" style="--fa-primary-color: #000000; --fa-secondary-color: #000000;"></i>
                                  </div>
                              ...
                              <p>Never worry about getting to the bank to make a deposit on payday. With direct deposit, relax and enjoy knowing that your account has already been credited.</p>

                              <p>Direct deposit is the safest and most convenient way for deposits to be made each pay period. Deposits are made electronically and may be performed by your employer, pension plan administrator, or the Social Security Administration.</p>

                              <p>You will save time by not waiting in line and may even earn extra interest, since your account is credited on the actual pay date. Loan payments as well as distributions among your various accounts can be made through this convenient service.</p>

                              <div class="align-content-bottom">
                                <p><a class="button" aria-label="Direct Deposit Form" rel="nofollow" target="_blank" href="https://q2-canvas-stg-files.s3.amazonaws.com/firstunitedbank-com/files/document/directdeposit_2015.pdf?rQK0CzFPgq4zVxG_DEkVrLIPOJ7SiZKW=" title="Direct Deposit Form">Direct Deposit Form</a></p>
                              </div>
                      ...
                      <div class="q2-section general-section gutter-both ">
                        <div class="q2-wrap grid-container">
                          ...
                          <div id="overdraft-advantage">
                            <h2>Overdraft Advantage®</h2>

                            <p>&nbsp;</p>

                            <p>Beko Federal Credit Union offers the perfect solution to help manage your money when your funds are running a little low and there are too many days left in the month until payday.<br />
                              <br />
                              Overdraft Advantage® is subject to the Overdraft Advantage® Statement Policy, which limits the amount and number of overdrafts and contains certain terms and conditions. We reserve the right to limit, restrict or prohibit overdrafts on individual accounts depending on circumstances.<br />
                              <br />
                              Overdraft Advantage® minimizes mistakes that can ultimately cost you hundreds of dollars in merchant fees charged for returned checks. Even though we'll charge you the normal fee for each non-sufficient funds transaction that is processed through Overdraft Advantage®, you'll save money by avoiding costly merchant fees.<br />
                              <br />
                              Enjoy peace of mind knowing that your checks will be paid - saving you the time, money and embarrassment. Overdraft Advantage® is an invaluable service but there is no cost to enroll. Simply keep making your Beko Federal Credit Union checking account deposits in a timely manner to bring your account to a positive status within the required time period and we'll take care of the rest.<br />
                              <br />
                              Ask us today about getting Overdraft Advantage® and to receive a copy of the Overdraft Advantage® Statement Policy that contains service information.<br />
                              <br />
                              <em><u>Please Note:</u></em>
                            </p>

                            <ul>
                              <li><em>You will be charged $30&nbsp;when you don't have enough money in your checking account to cover a transaction.</em></li>
                              <li><em>Covered transactions include: the payment of checks, certain electronic funds transfers or other withdrawal requests, payments authorized by you, any deposit items returned unpaid, and the imposition of bank service charges.</em></li>
                              <li><em>Your account must have a positive balance at least once every 30 days.</em></li>
                              <li><em>You can choose to add additional coverage that covers your ATM and everyday debit card transactions as well.</em></li>
                            </ul>

                            <p><em>We may refuse to pay an overdraft for you at any time, even though your account is in good standing and even though we may have previously paid overdrafts for you.</em></p>
                      ...
                      <div class="q2-section call-to-action-section secondary gutter-none">
                        <div class="q2-wrap">
                          <p>Switching is now easier than ever with just 3 easy steps!</p>

                          <a href="https://bekofcu.com/simple-switch" class="button" aria-label="Simple Switch page">Simple Switch</a>
